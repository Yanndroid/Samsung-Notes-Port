...
# direct methods
.method public constructor <init>(Ll/b;Ll/e;)V
    .locals 1
    ...
    iput-object v0, p0, Ll/d;->a:Ljava/util/List;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Ll/d;->b:Ljava/util/List;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Ll/d;->c:Ljava/util/List;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, Ll/d;->f:Ljava/util/HashMap;

    iput-object p1, p0, Ll/d;->d:Ll/b;

    iput-object p2, p0, Ll/d;->e:Ll/e;
...
.method public final a()Z
    ...
    iget-object v1, p0, Ll/d;->c:Ljava/util/List;
    ...
    const-string v1, "CoeditShareSingleTask$CoeditShareSDoc"
    ...
    iget-object v2, p0, Ll/d;->d:Ll/b;

    invoke-virtual {v2}, Ll/b;->b()Landroid/content/Context;
    ...
    invoke-virtual {v3}, Ll/b;->b()Landroid/content/Context;
    ...
    iget-object v3, p0, Ll/d;->c:Ljava/util/List;
    ...
    iget-object v6, p0, Ll/d;->e:Ll/e;

    invoke-interface {v6}, Ll/e;->isCancelled()Z
...
.method public final b()Z
    ...
    iget-object v2, v1, Ll/d;->b:Ljava/util/List;
    ...
    const-string v2, "CoeditShareSingleTask$CoeditShareSDoc"
    ...
    iget-object v5, v1, Ll/d;->d:Ll/b;

    invoke-virtual {v5}, Ll/b;->b()Landroid/content/Context;
    ...
    iget-object v7, v1, Ll/d;->d:Ll/b;

    invoke-virtual {v7}, Ll/b;->b()Landroid/content/Context;
    ...
    iget-object v8, v1, Ll/d;->b:Ljava/util/List;
    ...
    iget-object v13, v1, Ll/d;->e:Ll/e;

    invoke-interface {v13}, Ll/e;->isCancelled()Z
    ...
    :cond_7
    iget-object v0, v1, Ll/d;->d:Ll/b;

    const/4 v2, 0x0

    invoke-virtual {v0, v2}, Ll/b;->g(Z)V
    ...
    iget-object v8, v1, Ll/d;->d:Ll/b;

    invoke-virtual {v8}, Ll/b;->b()Landroid/content/Context;
    ...
    iget-object v9, v1, Ll/d;->d:Ll/b;

    invoke-virtual {v9}, Ll/b;->b()Landroid/content/Context;
    ...
    iget-object v9, v1, Ll/d;->e:Ll/e;

    invoke-interface {v9, v8}, Ll/e;->onSharedFileUpdated(Ljava/lang/String;)V
...
.method public final c()Ljava/util/ArrayList;
    ...
    invoke-virtual {v3}, Ll/b;->d()Ljava/lang/String;
    ...
    invoke-virtual {v5}, Lcom/samsung/android/support/senl/nt/data/database/core/sync/entity/DocSyncEntry;->getCategoryUuid()Ljava/lang/String;

    move-result-object v6

    const-string v7, "coedit:///"
    ...
    :cond_5
    const-string v2, "Failed to get all uuid List for coedit"
...
.method public final d()Ljava/util/ArrayList;
    ...
    const-string v6, "CoeditShareSingleTask$CoeditShareSDoc"
    ...
    :try_start_0
    invoke-static {}, Lu/f;->q()Lcom/samsung/android/sdk/mobileservice/common/result/BooleanResult;
    ...
    const-string v7, "succeed to SesCoeditShareApi.requestSync()"
    ...
    invoke-virtual {v8}, Ll/b;->d()Ljava/lang/String;
    ...
    invoke-virtual {v9}, Ll/b;->d()Ljava/lang/String;
...
.method public final e(Ljava/util/ArrayList;)Z
    ...
    const-string v0, "CoeditShareSingleTask$CoeditShareSDoc"
    ...
    iget-object v5, p0, Ll/d;->f:Ljava/util/HashMap;
    ...
    iget-object v6, p0, Ll/d;->f:Ljava/util/HashMap;
    ...
    iget-object v3, p0, Ll/d;->b:Ljava/util/List;
    ...
    :goto_1
    iget-object v4, p0, Ll/d;->a:Ljava/util/List;
    ...
    :cond_7
    iget-object v4, p0, Ll/d;->c:Ljava/util/List;

    goto :goto_2

    :cond_8
    :goto_4
    iget-object v4, p0, Ll/d;->d:Ll/b;

    invoke-virtual {v4}, Ll/b;->b()Landroid/content/Context;
    ...
    :cond_a
    iget-object p1, p0, Ll/d;->f:Ljava/util/HashMap;
    ...
    iget-object v2, p0, Ll/d;->b:Ljava/util/List;
    ...
    iget-object v1, p0, Ll/d;->a:Ljava/util/List;
    ...
    iget-object v1, p0, Ll/d;->b:Ljava/util/List;
...
.method public f()Z
    ...
    const-string v1, "[Start sharing coedit]"
    ...
    iget-object v3, p0, Ll/d;->e:Ll/e;

    invoke-interface {v3}, Ll/e;->isCancelled()Z
    ...
    invoke-virtual {p0}, Ll/d;->c()Ljava/util/ArrayList;

    move-result-object v3

    invoke-virtual {p0}, Ll/d;->d()Ljava/util/ArrayList;
    ...
    iget-object v7, p0, Ll/d;->f:Ljava/util/HashMap;
    ...
    :cond_1
    iget-object v5, p0, Ll/d;->e:Ll/e;

    invoke-interface {v5}, Ll/e;->isCancelled()Z
    ...
    :cond_2
    invoke-virtual {p0, v3}, Ll/d;->e(Ljava/util/ArrayList;)Z
    ...
    :cond_3
    iget-object v3, p0, Ll/d;->a:Ljava/util/List;

    invoke-interface {v3}, Ljava/util/List;->size()I

    move-result v3

    iget-object v5, p0, Ll/d;->b:Ljava/util/List;
    ...
    iget-object v5, p0, Ll/d;->c:Ljava/util/List;
    ...
    const-string v2, "[Finish sharing coedit] et = "
    ...
    invoke-virtual {v0, v4}, Ll/b;->h(Z)V

    iget-object v0, p0, Ll/d;->d:Ll/b;

    invoke-virtual {v0, v4}, Ll/b;->g(Z)V
...
.method public final g(Ljava/util/List;Ljava/lang/String;)Ld1/e;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public final h()Z
    ...
    iget-object v0, v1, Ll/d;->a:Ljava/util/List;
    ...
    const-string v3, "CoeditShareSingleTask$CoeditShareSDoc"
    ...
    iget-object v12, v1, Ll/d;->e:Ll/e;

    invoke-interface {v12}, Ll/e;->isCancelled()Z
    ...
    iget-object v11, v1, Ll/d;->d:Ll/b;

    invoke-virtual {v11}, Ll/b;->b()Landroid/content/Context;
    ...
    iget-object v12, v1, Ll/d;->a:Ljava/util/List;

    invoke-virtual {v1, v12, v11}, Ll/d;->g(Ljava/util/List;Ljava/lang/String;)Ld1/e;
    ...
    invoke-virtual {v0, v2}, Ll/b;->a(Ly1/a;)V
