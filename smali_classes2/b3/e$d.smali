...
.method public constructor <init>(Lcom/samsung/android/app/notes/sync/constants/DocTypeConstants;)V
    ...
    iput-object p1, p0, Lb3/e$d;->a:Lcom/samsung/android/app/notes/sync/constants/DocTypeConstants;
...
.method public a(Landroid/content/Context;)Lcom/samsung/android/support/senl/nt/base/common/tipcard/TipCard;
    ...
    iget-object p1, p0, Lb3/e$d;->a:Lcom/samsung/android/app/notes/sync/constants/DocTypeConstants;
    ...
    const-string p1, "add TipCardFailToSyncNotEnoughDeviceStorage!"
    ...
    invoke-direct {p1}, Lb3/q;-><init>()V

    return-object p1

    :cond_0
    const-string p1, "add TipCardFailToImportDeviceStorageFull!"
