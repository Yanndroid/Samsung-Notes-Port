...
.method public static constructor <clinit>()V
    ...
    invoke-direct {v1, v3, v4}, Lcom/microsoft/identity/common/logging/Logger$LogLevel;-><init>(Ljava/lang/String;I)V
    ...
    invoke-direct {v3, v5, v6}, Lcom/microsoft/identity/common/logging/Logger$LogLevel;-><init>(Ljava/lang/String;I)V

    sput-object v3, Lcom/microsoft/identity/common/logging/Logger$LogLevel;->INFO:Lcom/microsoft/identity/common/logging/Logger$LogLevel;

    new-instance v5, Lcom/microsoft/identity/common/logging/Logger$LogLevel;

    const-string v7, "VERBOSE"

    const/4 v8, 0x3

    invoke-direct {v5, v7, v8}, Lcom/microsoft/identity/common/logging/Logger$LogLevel;-><init>(Ljava/lang/String;I)V

    sput-object v5, Lcom/microsoft/identity/common/logging/Logger$LogLevel;->VERBOSE:Lcom/microsoft/identity/common/logging/Logger$LogLevel;

    const/4 v7, 0x4

    new-array v7, v7, [Lcom/microsoft/identity/common/logging/Logger$LogLevel;
    ...
    sput-object v7, Lcom/microsoft/identity/common/logging/Logger$LogLevel;->$VALUES:[Lcom/microsoft/identity/common/logging/Logger$LogLevel;
...
.method private static convertFromJavaLogLevel(Lcom/microsoft/identity/common/java/logging/Logger$LogLevel;)Lcom/microsoft/identity/common/logging/Logger$LogLevel;
    .locals 1
    .param p0    # Lcom/microsoft/identity/common/java/logging/Logger$LogLevel;
