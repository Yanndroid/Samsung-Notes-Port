...
# static fields
.field private static final TAG:Ljava/lang/String; = "BasicSigner"
...
.method public sign(Ljava/security/PrivateKey;Ljava/lang/String;[B)[B
    ...
    const-string v0, "signingAlgorithm is marked non-null but is null"
    ...
    const-string v0, "failed_to_sign"
...
.method public signWithHMac([BLjava/lang/String;[B)[B
    .locals 3
    .param p2    # Ljava/lang/String;
        .annotation build Llombok/NonNull;
        .end annotation
    ...
    const-string v0, "signWithDerivedKey"

    const-string v1, "hmacAlgorithm is marked non-null but is null"
    ...
    const-string p3, "Key is invalid for signing "
    ...
    sget-object v1, Lcom/microsoft/identity/common/java/crypto/BasicSigner;->TAG:Ljava/lang/String;
    ...
    invoke-static {p3, p2, p1}, Lcom/microsoft/identity/common/java/logging/Logger;->error(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V

    new-instance p3, Lcom/microsoft/identity/common/java/exception/ClientException;

    const-string v0, "invalid_key"

    invoke-direct {p3, v0, p2, p1}, Lcom/microsoft/identity/common/java/exception/ClientException;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    sget-object p3, Lcom/microsoft/identity/common/java/crypto/BasicSigner;->TAG:Ljava/lang/String;
    ...
    const-string p2, " algorithm does not exist "
