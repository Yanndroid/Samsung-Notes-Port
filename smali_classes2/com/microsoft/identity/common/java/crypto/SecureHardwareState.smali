...
.method public static constructor <clinit>()V
    ...
    const-string v3, "TRUE_UNATTESTED"

    const/4 v4, 0x1

    invoke-direct {v1, v3, v4}, Lcom/microsoft/identity/common/java/crypto/SecureHardwareState;-><init>(Ljava/lang/String;I)V
    ...
    invoke-direct {v3, v5, v6}, Lcom/microsoft/identity/common/java/crypto/SecureHardwareState;-><init>(Ljava/lang/String;I)V

    sput-object v3, Lcom/microsoft/identity/common/java/crypto/SecureHardwareState;->FALSE:Lcom/microsoft/identity/common/java/crypto/SecureHardwareState;

    new-instance v5, Lcom/microsoft/identity/common/java/crypto/SecureHardwareState;

    const-string v7, "UNKNOWN_DOWNLEVEL"

    const/4 v8, 0x3

    invoke-direct {v5, v7, v8}, Lcom/microsoft/identity/common/java/crypto/SecureHardwareState;-><init>(Ljava/lang/String;I)V

    sput-object v5, Lcom/microsoft/identity/common/java/crypto/SecureHardwareState;->UNKNOWN_DOWNLEVEL:Lcom/microsoft/identity/common/java/crypto/SecureHardwareState;

    new-instance v7, Lcom/microsoft/identity/common/java/crypto/SecureHardwareState;

    const-string v9, "UNKNOWN_QUERY_ERROR"

    const/4 v10, 0x4

    invoke-direct {v7, v9, v10}, Lcom/microsoft/identity/common/java/crypto/SecureHardwareState;-><init>(Ljava/lang/String;I)V

    sput-object v7, Lcom/microsoft/identity/common/java/crypto/SecureHardwareState;->UNKNOWN_QUERY_ERROR:Lcom/microsoft/identity/common/java/crypto/SecureHardwareState;

    const/4 v9, 0x5

    new-array v9, v9, [Lcom/microsoft/identity/common/java/crypto/SecureHardwareState;
    ...
    sput-object v9, Lcom/microsoft/identity/common/java/crypto/SecureHardwareState;->$VALUES:[Lcom/microsoft/identity/common/java/crypto/SecureHardwareState;
