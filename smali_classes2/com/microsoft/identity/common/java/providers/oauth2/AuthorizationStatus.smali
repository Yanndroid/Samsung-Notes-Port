...
.method public static constructor <clinit>()V
    ...
    invoke-direct {v1, v3, v4}, Lcom/microsoft/identity/common/java/providers/oauth2/AuthorizationStatus;-><init>(Ljava/lang/String;I)V
    ...
    const-string v5, "SDK_CANCEL"

    const/4 v6, 0x2

    invoke-direct {v3, v5, v6}, Lcom/microsoft/identity/common/java/providers/oauth2/AuthorizationStatus;-><init>(Ljava/lang/String;I)V

    sput-object v3, Lcom/microsoft/identity/common/java/providers/oauth2/AuthorizationStatus;->SDK_CANCEL:Lcom/microsoft/identity/common/java/providers/oauth2/AuthorizationStatus;

    new-instance v5, Lcom/microsoft/identity/common/java/providers/oauth2/AuthorizationStatus;

    const-string v7, "FAIL"

    const/4 v8, 0x3

    invoke-direct {v5, v7, v8}, Lcom/microsoft/identity/common/java/providers/oauth2/AuthorizationStatus;-><init>(Ljava/lang/String;I)V

    sput-object v5, Lcom/microsoft/identity/common/java/providers/oauth2/AuthorizationStatus;->FAIL:Lcom/microsoft/identity/common/java/providers/oauth2/AuthorizationStatus;

    new-instance v7, Lcom/microsoft/identity/common/java/providers/oauth2/AuthorizationStatus;

    const-string v9, "INVALID_REQUEST"

    const/4 v10, 0x4

    invoke-direct {v7, v9, v10}, Lcom/microsoft/identity/common/java/providers/oauth2/AuthorizationStatus;-><init>(Ljava/lang/String;I)V

    sput-object v7, Lcom/microsoft/identity/common/java/providers/oauth2/AuthorizationStatus;->INVALID_REQUEST:Lcom/microsoft/identity/common/java/providers/oauth2/AuthorizationStatus;

    const/4 v9, 0x5

    new-array v9, v9, [Lcom/microsoft/identity/common/java/providers/oauth2/AuthorizationStatus;
    ...
    sput-object v9, Lcom/microsoft/identity/common/java/providers/oauth2/AuthorizationStatus;->$VALUES:[Lcom/microsoft/identity/common/java/providers/oauth2/AuthorizationStatus;
