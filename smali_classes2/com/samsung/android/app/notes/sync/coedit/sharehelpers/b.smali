.class public abstract Lcom/samsung/android/app/notes/sync/coedit/sharehelpers/b;
...
.field public i:Lcom/samsung/android/app/notes/sync/coedit/basecore/CoeditSDocTask;
...
.method public constructor <init>(Landroid/content/Context;Ljava/lang/Class;)V
    ...
    iput-object p1, p0, Lcom/samsung/android/app/notes/sync/coedit/sharehelpers/b;->h:Lj/b;
...
.method public a(Ljava/lang/String;)V
    ...
    iget-object v0, p0, Lcom/samsung/android/app/notes/sync/coedit/sharehelpers/b;->h:Lj/b;

    if-eqz v0, :cond_0

    invoke-interface {v0, p1}, Lj/b;->a(Ljava/lang/String;)V

    :cond_0
    iget-boolean p1, p0, Lcom/samsung/android/app/notes/sync/coedit/sharehelpers/CoeditAbsShareHelper;->d:Z

    if-eqz p1, :cond_1

    iget-object p1, p0, Lcom/samsung/android/app/notes/sync/coedit/sharehelpers/CoeditAbsShareHelper;->b:Landroid/content/Context;

    iget-object v0, p0, Lcom/samsung/android/app/notes/sync/coedit/sharehelpers/CoeditAbsShareHelper;->g:Landroid/content/ServiceConnection;
...
.method public c(Ljava/lang/String;Ljava/util/ArrayList;)V
    ...
    invoke-interface {v0, p1, p2}, Lj/b;->c(Ljava/lang/String;Ljava/util/ArrayList;)V
...
.method public i(Ly1/a;)V
    ...
    iget-object p1, p0, Lcom/samsung/android/app/notes/sync/coedit/sharehelpers/CoeditAbsShareHelper;->f:Ljava/lang/String;

    invoke-virtual {p0, p1, v0}, Lcom/samsung/android/app/notes/sync/coedit/sharehelpers/b;->c(Ljava/lang/String;Ljava/util/ArrayList;)V
...
.method public k(Ljava/util/concurrent/Executor;Ljava/lang/String;Ljava/util/List;)Z
    ...
    iput-object p3, p0, Lcom/samsung/android/app/notes/sync/coedit/sharehelpers/b;->j:Ljava/util/List;
...
.method public m()V
    ...
    :try_start_0
    iget-object v0, p0, Lcom/samsung/android/app/notes/sync/coedit/sharehelpers/b;->i:Lcom/samsung/android/app/notes/sync/coedit/basecore/CoeditSDocTask;

    if-eqz v0, :cond_1

    invoke-virtual {v0}, Lcom/samsung/android/app/notes/sync/coedit/basecore/CoeditSDocTask;->stop()V

    const/4 v0, 0x0

    iput-object v0, p0, Lcom/samsung/android/app/notes/sync/coedit/sharehelpers/b;->i:Lcom/samsung/android/app/notes/sync/coedit/basecore/CoeditSDocTask;
    ...
    invoke-interface {v0, v1}, Lj/b;->a(Ljava/lang/String;)V
