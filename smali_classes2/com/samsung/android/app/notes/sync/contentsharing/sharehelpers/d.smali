.class public Lcom/samsung/android/app/notes/sync/contentsharing/sharehelpers/d;
...
# instance fields
.field public h:Lcom/samsung/android/app/notes/sync/contentsharing/sharecore/strategy/ShareBaseTask$a;

.field public i:I

.field public j:Lcom/samsung/android/app/notes/sync/contentsharing/sharecore/strategy/ShareSingleTask;
...
.method public constructor <init>(Landroid/content/Context;Ljava/lang/Class;)V
    ...
    iput-object p1, p0, Lcom/samsung/android/app/notes/sync/contentsharing/sharehelpers/d;->h:Lcom/samsung/android/app/notes/sync/contentsharing/sharecore/strategy/ShareBaseTask$a;

    const/4 p1, 0x0

    iput p1, p0, Lcom/samsung/android/app/notes/sync/contentsharing/sharehelpers/d;->i:I
...
.method public b()V
    ...
    const-string v0, "SdocShareHelper"
    ...
    iput v0, p0, Lcom/samsung/android/app/notes/sync/contentsharing/sharehelpers/d;->i:I

    iget-object v1, p0, Lcom/samsung/android/app/notes/sync/contentsharing/sharehelpers/d;->h:Lcom/samsung/android/app/notes/sync/contentsharing/sharecore/strategy/ShareBaseTask$a;

    if-eqz v1, :cond_0

    invoke-interface {v1}, Lcom/samsung/android/app/notes/sync/contentsharing/sharecore/strategy/ShareBaseTask$a;->b()V

    :cond_0
    iget-boolean v1, p0, Lcom/samsung/android/app/notes/sync/contentsharing/sharehelpers/AbsShareHelper;->d:Z

    if-eqz v1, :cond_1

    iget-object v1, p0, Lcom/samsung/android/app/notes/sync/contentsharing/sharehelpers/AbsShareHelper;->b:Landroid/content/Context;
...
.method public d(Ljava/lang/String;)V
    ...
    :try_start_0
    iget-object v0, p0, Lcom/samsung/android/app/notes/sync/contentsharing/sharehelpers/d;->h:Lcom/samsung/android/app/notes/sync/contentsharing/sharecore/strategy/ShareBaseTask$a;
...
.method public f(Ljava/util/ArrayList;)V
    ...
    invoke-interface {v0, p1}, Lcom/samsung/android/app/notes/sync/contentsharing/sharecore/strategy/ShareBaseTask$a;->f(Ljava/util/ArrayList;)V
...
.method public i(Ly1/a;)V
    ...
    invoke-virtual {p0, v0}, Lcom/samsung/android/app/notes/sync/contentsharing/sharehelpers/d;->f(Ljava/util/ArrayList;)V
...
.method public j(Ljava/lang/String;)V
    ...
    :try_start_0
    new-instance p1, Lcom/samsung/android/app/notes/sync/contentsharing/sharecore/strategy/ShareSingleTask;

    iget-object v0, p0, Lcom/samsung/android/app/notes/sync/contentsharing/sharehelpers/AbsShareHelper;->b:Landroid/content/Context;

    iget-object v1, p0, Lcom/samsung/android/app/notes/sync/contentsharing/sharehelpers/AbsShareHelper;->f:Ljava/lang/String;

    invoke-direct {p1, v0, p0, v1}, Lcom/samsung/android/app/notes/sync/contentsharing/sharecore/strategy/ShareSingleTask;-><init>(Landroid/content/Context;Lcom/samsung/android/app/notes/sync/contentsharing/sharecore/strategy/ShareBaseTask$a;Ljava/lang/String;)V

    iput-object p1, p0, Lcom/samsung/android/app/notes/sync/contentsharing/sharehelpers/d;->j:Lcom/samsung/android/app/notes/sync/contentsharing/sharecore/strategy/ShareSingleTask;
...
.method public l(Ljava/util/concurrent/Executor;Ljava/lang/String;)Z
    ...
    :cond_0
    const-string p1, "SdocShareHelper"
...
.method public m(Lcom/samsung/android/app/notes/sync/contentsharing/sharecore/strategy/ShareBaseTask$a;)V
    .locals 0
...
.method public n()V
    ...
    :try_start_0
    iget-object v0, p0, Lcom/samsung/android/app/notes/sync/contentsharing/sharehelpers/d;->j:Lcom/samsung/android/app/notes/sync/contentsharing/sharecore/strategy/ShareSingleTask;

    if-eqz v0, :cond_1

    invoke-virtual {v0}, Lcom/samsung/android/app/notes/sync/contentsharing/sharecore/strategy/ShareBaseTask;->stop()V

    const/4 v0, 0x0

    iput-object v0, p0, Lcom/samsung/android/app/notes/sync/contentsharing/sharehelpers/d;->j:Lcom/samsung/android/app/notes/sync/contentsharing/sharecore/strategy/ShareSingleTask;
    ...
    const-string v1, "SdocShareHelper"
