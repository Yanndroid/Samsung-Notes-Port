.class public Lcom/samsung/android/app/notes/sync/importing/core/types/SSLMemoSync;
.super Lcom/samsung/android/app/notes/sync/importing/core/tasks/MigrationImportBaseTask;
.source "SourceFile"


# static fields
.field private static final LMEMO_UUID_ARRAY_NAME:Ljava/lang/String; = "UuidList"

.field private static final LMEMO_UUID_FILE_EXTENSION:Ljava/lang/String; = ".luid"

.field private static final LMEMO_UUID_FOLDER_NAME:Ljava/lang/String; = "LUID"

.field private static final TAG:Ljava/lang/String; = "SS$SSLMemoSync"
...
.method public constructor <init>(Landroid/content/Context;Lcom/samsung/android/app/notes/sync/importing/core/tasks/ImportBaseTask$a;ILjava/util/List;Z)V
    ...
    sget-object v3, Lcom/samsung/android/app/notes/sync/constants/DocTypeConstants;->SS_LMEMO:Lcom/samsung/android/app/notes/sync/constants/DocTypeConstants;
...
.method public static bridge synthetic a(Lcom/samsung/android/app/notes/sync/importing/core/types/SSLMemoSync;II)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lcom/samsung/android/app/notes/sync/importing/core/types/SSLMemoSync;->updateProgress(II)V

    return-void
.end method

.method public static synthetic access$000(Lcom/samsung/android/app/notes/sync/importing/core/types/SSLMemoSync;I)V
    .locals 0
...
.method private checkLMemoUuid(Ljava/lang/String;)Ljava/util/ArrayList;
    .locals 19
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    const-string v3, "SS$SSLMemoSync"

    const-string v4, "checkLMemoUuid"
    ...
    :try_start_3
    const-string v0, "LMemo UUID is empty. Not supported."
    ...
    invoke-direct {v1, v7}, Lcom/samsung/android/app/notes/sync/importing/core/types/SSLMemoSync;->closeStream(Ljava/io/Closeable;)V
    ...
    :catch_3
    :try_start_7
    const-string v0, "Cannot get LMemo last modified time from JSON file."
    ...
    :goto_2
    invoke-direct {v1, v15, v4, v5}, Lcom/samsung/android/app/notes/sync/importing/core/types/SSLMemoSync;->checkNeedToRestoreLMemo(Ljava/io/File;J)Z
    ...
    invoke-direct {v1, v2}, Lcom/samsung/android/app/notes/sync/importing/core/types/SSLMemoSync;->closeStream(Ljava/io/Closeable;)V
    ...
    :goto_f
    invoke-direct {v1, v8}, Lcom/samsung/android/app/notes/sync/importing/core/types/SSLMemoSync;->closeStream(Ljava/io/Closeable;)V
...
.method private checkNeedToRestoreLMemo(Ljava/io/File;J)Z
    .locals 4

    invoke-direct {p0, p1}, Lcom/samsung/android/app/notes/sync/importing/core/types/SSLMemoSync;->getUuidListFromLuidFile(Ljava/io/File;)Ljava/util/ArrayList;

    move-result-object p1

    const/4 v0, 0x1

    const-string v1, "SS$SSLMemoSync"
    ...
    :cond_0
    invoke-direct {p0, p1}, Lcom/samsung/android/app/notes/sync/importing/core/types/SSLMemoSync;->isRestoredFileDeleted(Ljava/util/ArrayList;)Z

    move-result v2

    if-eqz v2, :cond_1

    const-string p1, "One of restored files is deleted. Restore this LMemo."
    ...
    :cond_1
    invoke-direct {p0, p1}, Lcom/samsung/android/app/notes/sync/importing/core/types/SSLMemoSync;->getLastModifiedTimeOfSDoc(Ljava/util/ArrayList;)J
    ...
    const-string p1, "Last modified time is different. Restore this LMemo."
    ...
    :cond_3
    :goto_1
    const-string p1, "Cannot find restored info. Restore this LMemo."
...
.method private clearTempFiles()V
    ...
    const-string v0, "SS$SSLMemoSync"
    ...
    :cond_0
    :goto_0
    invoke-virtual {p0}, Lcom/samsung/android/app/notes/sync/importing/core/types/SSLMemoSync;->unsetRunningFlag()V
...
.method private getUuidListFromLuidFile(Ljava/io/File;)Ljava/util/ArrayList;
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    const-string v3, "JSONException while getting UUID list form luid file. "
    ...
    :cond_2
    :goto_1
    const-string p1, "getUuidListFromLuidFile. File not exist."
...
.method private importItems()I
    ...
    iget-object v4, p0, Lcom/samsung/android/app/notes/sync/importing/core/tasks/ImportBaseTask;->mSuccessfulList:Ljava/util/List;
    ...
    iput-object v4, p0, Lcom/samsung/android/app/notes/sync/importing/core/tasks/ImportBaseTask;->mSuccessfulList:Ljava/util/List;

    :cond_0
    const/4 v4, 0x0

    :try_start_0
    const-string v5, "Start converting"
    ...
    invoke-static {v2, v0}, Lcom/samsung/android/app/notes/sync/utils/a;->b(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v5

    invoke-direct {p0, v5}, Lcom/samsung/android/app/notes/sync/importing/core/types/SSLMemoSync;->checkLMemoUuid(Ljava/lang/String;)Ljava/util/ArrayList;
    ...
    const-string v5, "Nothing to restore. Finish import."
    ...
    invoke-direct {v8}, Lz/b;-><init>()V

    new-instance v9, Lcom/samsung/android/app/notes/sync/importing/core/types/SSLMemoSync$a;

    invoke-direct {v9, p0, v6, v7, v5}, Lcom/samsung/android/app/notes/sync/importing/core/types/SSLMemoSync$a;-><init>(Lcom/samsung/android/app/notes/sync/importing/core/types/SSLMemoSync;ZLjava/util/HashMap;Ljava/util/ArrayList;)V

    invoke-virtual {v8, v2, v9}, Lz/b;->a(Ljava/lang/String;Lx/d$a;)Z

    const-string v5, "Succeed to convert"

    invoke-static {v1, v5}, Lcom/samsung/android/support/senl/nt/base/common/log/Debugger;->i(Ljava/lang/String;Ljava/lang/String;)V

    if-eqz v6, :cond_3

    invoke-direct {p0, v7}, Lcom/samsung/android/app/notes/sync/importing/core/types/SSLMemoSync;->makeLMemoUuidFile(Ljava/util/HashMap;)V
    ...
    const-string v0, "Failed to delete LMemo file"
    ...
    const-string v3, "Exception LMemo "
...
.method private makeLMemoUuidFile(Ljava/util/HashMap;)V
    .locals 14
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    const-string v1, "Start to make LMemo Uuid Log - "
    ...
    const-string v2, "folder was not created"
    ...
    const-string v8, "LUID file name : "
    ...
    :cond_3
    :goto_3
    invoke-direct {p0, v3}, Lcom/samsung/android/app/notes/sync/importing/core/types/SSLMemoSync;->closeStream(Ljava/io/Closeable;)V
    ...
    const-string v6, "IOException while writing LUID file. "
    ...
    const-string v6, "JSONException while writing LUID file. "
...
.method private sendResponseEntireRestore(I)V
    .locals 2
    ...
    invoke-virtual {p0, p1, p1}, Lcom/samsung/android/app/notes/sync/importing/core/tasks/MigrationImportBaseTask;->sendResponseEntireRestore(II)V
    ...
    invoke-virtual {p0, v1, v1}, Lcom/samsung/android/app/notes/sync/importing/core/tasks/MigrationImportBaseTask;->sendResponseEntireRestore(II)V
    ...
    invoke-virtual {p0, v1, p1}, Lcom/samsung/android/app/notes/sync/importing/core/tasks/MigrationImportBaseTask;->sendResponseEntireRestore(II)V
...
.method private updateProgress(II)V
    ...
    sget-object v1, Lcom/samsung/android/app/notes/sync/constants/DocTypeConstants;->SS_LMEMO:Lcom/samsung/android/app/notes/sync/constants/DocTypeConstants;
...
.method public getImportItems()V
    ...
    sget-object v4, Lcom/samsung/android/app/notes/sync/constants/DocTypeConstants;->SS_LMEMO:Lcom/samsung/android/app/notes/sync/constants/DocTypeConstants;
...
.method public startImport()V
    ...
    invoke-direct {p0}, Lcom/samsung/android/app/notes/sync/importing/core/types/SSLMemoSync;->importItems()I

    move-result v0

    invoke-direct {p0}, Lcom/samsung/android/app/notes/sync/importing/core/types/SSLMemoSync;->clearTempFiles()V

    invoke-direct {p0, v0}, Lcom/samsung/android/app/notes/sync/importing/core/types/SSLMemoSync;->sendResponseEntireRestore(I)V
