...
# direct methods
.method public constructor <init>(Ls2/e;Ljava/util/HashMap;Ljava/lang/String;)V
    .locals 0

    iput-object p1, p0, Ls2/e$a;->c:Ls2/e;

    iput-object p2, p0, Ls2/e$a;->a:Ljava/util/HashMap;

    iput-object p3, p0, Ls2/e$a;->b:Ljava/lang/String;
...
.method public a(I)V
    ...
    const-string v1, "[UELT] onResponse - SYNC_TAG_FILENAME = "
    ...
    iget-object p1, p0, Ls2/e$a;->a:Ljava/util/HashMap;
    ...
    iget-object v5, p0, Ls2/e$a;->c:Ls2/e;

    invoke-static {v5}, Ls2/e;->a(Ls2/e;)Lt2/b;
    ...
    invoke-interface {v0, v5, v2}, Lb0/c;->getNoteTagServerTimestamp(Landroid/content/Context;Ljava/lang/String;)J
    ...
    invoke-static {v3}, Ls2/e;->a(Ls2/e;)Lt2/b;
    ...
    invoke-interface {v0, v3, v2, v4}, Lb0/c;->setNoteTagDirty(Landroid/content/Context;Ljava/lang/String;I)V

    goto :goto_0

    :cond_1
    const-string p1, "[UELT] finish to check DB!"
    ...
    iget-object v0, p0, Ls2/e$a;->b:Ljava/lang/String;
    ...
    const-string p1, "[UELT] failed to delete zipfile"
    ...
    invoke-static {p1}, Ls2/e;->a(Ls2/e;)Lt2/b;
    ...
    :cond_3
    const-string p1, "[UELT] onResponse finish"
