...
.method public static constructor <clinit>()V
    ...
    const-string v0, "NewHashTagCreator"
...
.method public b(Landroid/content/Context;Lcom/samsung/android/app/notes/sync/migration/common/Type$Work;Ljava/lang/String;)V
    ...
    sget-object v1, Lr1/f;->a:Ljava/lang/String;
    ...
    invoke-virtual {p1}, Lcom/samsung/android/support/senl/nt/data/repository/tag/NotesTagRepository;->getAll()Ljava/util/List;
    ...
    invoke-virtual {v2}, Lcom/samsung/android/support/senl/nt/data/database/core/document/entry/entity/NotesTagEntity;->getId()Ljava/lang/Long;

    move-result-object v3

    invoke-virtual {v2}, Lcom/samsung/android/support/senl/nt/data/database/core/document/entry/entity/NotesTagEntity;->getDocUuid()Ljava/lang/String;
    ...
    invoke-virtual {v2}, Lcom/samsung/android/support/senl/nt/data/database/core/document/entry/entity/NotesTagEntity;->getNormalizeName()Ljava/lang/String;

    move-result-object v2

    invoke-static {v3, v4, v5, v2}, Lv1/b;->a(Ljava/lang/Long;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Lv1/a;

    move-result-object v2

    invoke-interface {v1, v2}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    sget-object v2, Lr1/f;->a:Ljava/lang/String;

    new-instance v3, Ljava/lang/StringBuilder;

    invoke-direct {v3}, Ljava/lang/StringBuilder;-><init>()V

    const-string v4, "create display name "
    ...
    invoke-virtual {v8}, Lv1/a;->c()Ljava/lang/Long;

    move-result-object v8

    invoke-virtual {v6, v7, v8}, Lorg/json/JSONObject;->put(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;

    const-string v7, "doc_uuid"
    ...
    invoke-virtual {v8}, Lv1/a;->b()Ljava/lang/String;
    ...
    invoke-virtual {v8}, Lv1/a;->a()Ljava/lang/String;

    move-result-object v8

    invoke-virtual {v6, v7, v8}, Lorg/json/JSONObject;->put(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;

    const-string v7, "nomalize_name"
    ...
    invoke-virtual {v8}, Lv1/a;->d()Ljava/lang/String;
    ...
    :cond_2
    const-string v1, "hashtag_info"

    invoke-virtual {v2, v1, v3}, Lorg/json/JSONObject;->put(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;

    new-instance v1, Ljava/io/File;

    const-string v3, "hashtagNote4.list"
    ...
    sget-object p3, Lr1/f;->a:Ljava/lang/String;

    const-string v3, "create failed to delete tag.list file"
    ...
    const-string v3, "create failed to backupHashTagInfo "
    ...
    sget-object p1, Lr1/f;->a:Ljava/lang/String;
