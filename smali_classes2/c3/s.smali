...
.method public static b()Ljava/lang/String;
    ...
    sget-object v0, Lc3/s;->a:Ljava/lang/String;
...
.method public static d(Ljava/io/File;Ljava/io/File;ZZ)V
    .locals 21
    ...
    const-string/jumbo v8, "unzip() - start, zipFile = ["
    ...
    sput-object v7, Lc3/s;->a:Ljava/lang/String;

    invoke-static/range {p1 .. p1}, Lc3/s;->c(Ljava/io/File;)V
    ...
    invoke-static {v8, v5}, Lcom/samsung/android/support/senl/nt/base/common/log/Debugger;->d(Ljava/lang/String;Ljava/lang/String;)V

    sput-object v13, Lc3/s;->a:Ljava/lang/String;
    ...
    const-string/jumbo v13, "unzip() - skip ["
    ...
    invoke-static {v6}, Lc3/s;->c(Ljava/io/File;)V
    ...
    invoke-virtual {v12, v5, v14, v13}, Ljava/io/BufferedOutputStream;->write([BII)V
    ...
    const-string/jumbo v2, "unzip() - fail relative path!"
    ...
    :try_end_b
    .catch Ljava/util/zip/ZipException; {:try_start_b .. :try_end_b} :catch_1
    ...
    throw v2
    :try_end_d
    .catch Ljava/util/zip/ZipException; {:try_start_d .. :try_end_d} :catch_1
    ...
    const-string/jumbo v1, "unzip() - targetDir can not be null."
    ...
    const-string/jumbo v1, "unzip() - zipFile can not be null."
...
.method public static e(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v0}, Lc3/s;->c(Ljava/io/File;)V
    ...
    invoke-static {p1, p0, v0}, Lc3/s;->f(Ljava/io/File;Ljava/lang/String;Ljava/util/zip/ZipOutputStream;)V
...
.method public static f(Ljava/io/File;Ljava/lang/String;Ljava/util/zip/ZipOutputStream;)V
    .locals 5
    ...
    invoke-static {v2, v3, p2}, Lc3/s;->f(Ljava/io/File;Ljava/lang/String;Ljava/util/zip/ZipOutputStream;)V
    ...
    :cond_2
    invoke-virtual {v2, v1}, Ljava/util/zip/ZipEntry;->setMethod(I)V
    ...
    invoke-static {p0}, Lc3/s;->a(Ljava/io/File;)J

    move-result-wide p0

    invoke-virtual {v2, p0, p1}, Ljava/util/zip/ZipEntry;->setCrc(J)V
