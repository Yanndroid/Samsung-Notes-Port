...
.method public c()V
    ...
    invoke-direct {v0, v1}, Lb3/v;-><init>(Landroid/content/Context;)V
    ...
    const-string v0, "SyncErrorSyncNotEnoughCloudStorage"

    const-string v1, "Fail to sync due to not enough cloud storage"
