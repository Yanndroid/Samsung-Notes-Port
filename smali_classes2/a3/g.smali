...
.method public final a(Lcom/samsung/android/app/notes/sync/db/s;)V
    ...
    invoke-virtual {p0, p1}, La3/g;->e(Lcom/samsung/android/app/notes/sync/db/s;)Z
...
.method public b(Lcom/samsung/android/app/notes/sync/db/s;)V
    ...
    invoke-virtual {p0, v0, v1}, La3/g;->f(J)Z
    ...
    const-string v1, "Resource Lacking Note"
...
.method public c(Lcom/samsung/android/app/notes/sync/db/s;)V
    ...
    invoke-virtual {p0, p1}, La3/g;->g(Lcom/samsung/android/app/notes/sync/db/s;)V

    iget-object p1, p0, La3/g;->a:Ljava/lang/String;

    invoke-static {p1}, Lx2/c;->z(Ljava/lang/String;)V
...
.method public d(Lcom/samsung/android/app/notes/sync/db/s;)V
    ...
    invoke-virtual {p0, p1}, La3/g;->a(Lcom/samsung/android/app/notes/sync/db/s;)V

    iget-object v0, p0, La3/g;->a:Ljava/lang/String;

    invoke-virtual {p1}, Lcom/samsung/android/app/notes/sync/db/s;->v()J

    move-result-wide v1

    invoke-static {v0, v1, v2}, Lx2/c;->f(Ljava/lang/String;J)V

    new-instance p1, Lu0/k;

    iget-object v0, p0, La3/g;->a:Ljava/lang/String;

    invoke-direct {p1, v0}, Lu0/k;-><init>(Ljava/lang/String;)V
...
.method public f(J)Z
    ...
    invoke-static {v0}, Lx2/c;->s(Ljava/lang/String;)J
