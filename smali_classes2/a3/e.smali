...
.method public final a(Lcom/samsung/android/app/notes/sync/db/s;)V
    ...
    invoke-virtual {p0, p1}, La3/e;->e(Lcom/samsung/android/app/notes/sync/db/s;)Z
...
.method public b(Lcom/samsung/android/app/notes/sync/db/s;)V
    ...
    invoke-virtual {p0, v0, v1}, La3/e;->f(J)Z
    ...
    const-string v1, "Invalid data size"
...
.method public c(Lcom/samsung/android/app/notes/sync/db/s;)V
    ...
    invoke-virtual {p0, p1}, La3/e;->g(Lcom/samsung/android/app/notes/sync/db/s;)V

    iget-object p1, p0, La3/e;->a:Ljava/lang/String;

    invoke-static {p1}, Lx2/c;->x(Ljava/lang/String;)V
...
.method public d(Lcom/samsung/android/app/notes/sync/db/s;)V
    ...
    invoke-virtual {p0, p1}, La3/e;->a(Lcom/samsung/android/app/notes/sync/db/s;)V
    ...
    invoke-static {v0, v1, v2}, Lx2/c;->d(Ljava/lang/String;J)V

    new-instance p1, Lu0/g;

    iget-object v0, p0, La3/e;->a:Ljava/lang/String;

    invoke-direct {p1, v0}, Lu0/g;-><init>(Ljava/lang/String;)V
...
.method public f(J)Z
    ...
    invoke-static {v0}, Lx2/c;->m(Ljava/lang/String;)J
