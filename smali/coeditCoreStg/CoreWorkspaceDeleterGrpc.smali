.class public final LcoeditCoreStg/CoreWorkspaceDeleterGrpc;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        LcoeditCoreStg/CoreWorkspaceDeleterGrpc$MethodHandlers;,
        ...
        LcoeditCoreStg/CoreWorkspaceDeleterGrpc$CoreWorkspaceDeleterImplBase;
    }
.end annotation
...
.field public static final SERVICE_NAME:Ljava/lang/String; = "coeditCoreStg.CoreWorkspaceDeleter"
...
.method public static getDeleteWorkspaceMethod()Lio/grpc/MethodDescriptor;
    ...
    .annotation build Lio/grpc/stub/annotations/RpcMethod;
        fullMethodName = "coeditCoreStg.CoreWorkspaceDeleter/DeleteWorkspace"
        methodType = .enum Lio/grpc/MethodDescriptor$MethodType;->UNARY:Lio/grpc/MethodDescriptor$MethodType;
        requestType = LcoeditCoreInternalMessage/DeleteRequest;
        responseType = LcoeditCoreInternalMessage/DeleteResponse;
    .end annotation

    sget-object v0, LcoeditCoreStg/CoreWorkspaceDeleterGrpc;->getDeleteWorkspaceMethod:Lio/grpc/MethodDescriptor;

    if-nez v0, :cond_1

    const-class v1, LcoeditCoreStg/CoreWorkspaceDeleterGrpc;
    ...
    const-string v2, "coeditCoreStg.CoreWorkspaceDeleter"
    ...
    invoke-static {}, LcoeditCoreInternalMessage/DeleteRequest;->getDefaultInstance()LcoeditCoreInternalMessage/DeleteRequest;
    ...
    invoke-static {}, LcoeditCoreInternalMessage/DeleteResponse;->getDefaultInstance()LcoeditCoreInternalMessage/DeleteResponse;
    ...
    sput-object v0, LcoeditCoreStg/CoreWorkspaceDeleterGrpc;->getDeleteWorkspaceMethod:Lio/grpc/MethodDescriptor;
...
.method public static getServiceDescriptor()Lio/grpc/ServiceDescriptor;
    ...
    sget-object v0, LcoeditCoreStg/CoreWorkspaceDeleterGrpc;->serviceDescriptor:Lio/grpc/ServiceDescriptor;
    ...
    const-string v0, "coeditCoreStg.CoreWorkspaceDeleter"
    ...
    sput-object v0, LcoeditCoreStg/CoreWorkspaceDeleterGrpc;->serviceDescriptor:Lio/grpc/ServiceDescriptor;
...
.method public static newBlockingStub(Lio/grpc/Channel;)LcoeditCoreStg/CoreWorkspaceDeleterGrpc$CoreWorkspaceDeleterBlockingStub;
    .locals 1

    new-instance v0, LcoeditCoreStg/CoreWorkspaceDeleterGrpc$2;

    invoke-direct {v0}, LcoeditCoreStg/CoreWorkspaceDeleterGrpc$2;-><init>()V
    ...
    check-cast p0, LcoeditCoreStg/CoreWorkspaceDeleterGrpc$CoreWorkspaceDeleterBlockingStub;

    return-object p0
.end method

.method public static newFutureStub(Lio/grpc/Channel;)LcoeditCoreStg/CoreWorkspaceDeleterGrpc$CoreWorkspaceDeleterFutureStub;
    .locals 1

    new-instance v0, LcoeditCoreStg/CoreWorkspaceDeleterGrpc$3;

    invoke-direct {v0}, LcoeditCoreStg/CoreWorkspaceDeleterGrpc$3;-><init>()V
    ...
    check-cast p0, LcoeditCoreStg/CoreWorkspaceDeleterGrpc$CoreWorkspaceDeleterFutureStub;

    return-object p0
.end method

.method public static newStub(Lio/grpc/Channel;)LcoeditCoreStg/CoreWorkspaceDeleterGrpc$CoreWorkspaceDeleterStub;
    .locals 1

    new-instance v0, LcoeditCoreStg/CoreWorkspaceDeleterGrpc$1;

    invoke-direct {v0}, LcoeditCoreStg/CoreWorkspaceDeleterGrpc$1;-><init>()V
    ...
    check-cast p0, LcoeditCoreStg/CoreWorkspaceDeleterGrpc$CoreWorkspaceDeleterStub;
