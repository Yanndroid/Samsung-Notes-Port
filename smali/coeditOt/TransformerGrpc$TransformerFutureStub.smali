.class public final LcoeditOt/TransformerGrpc$TransformerFutureStub;
...
.method public synthetic constructor <init>(Lio/grpc/Channel;Lio/grpc/CallOptions;LcoeditOt/e;)V
    .locals 0

    invoke-direct {p0, p1, p2}, LcoeditOt/TransformerGrpc$TransformerFutureStub;-><init>(Lio/grpc/Channel;Lio/grpc/CallOptions;)V
...
# virtual methods
.method public build(Lio/grpc/Channel;Lio/grpc/CallOptions;)LcoeditOt/TransformerGrpc$TransformerFutureStub;
    .locals 1

    new-instance v0, LcoeditOt/TransformerGrpc$TransformerFutureStub;

    invoke-direct {v0, p1, p2}, LcoeditOt/TransformerGrpc$TransformerFutureStub;-><init>(Lio/grpc/Channel;Lio/grpc/CallOptions;)V
...
.method public bridge synthetic build(Lio/grpc/Channel;Lio/grpc/CallOptions;)Lio/grpc/stub/AbstractStub;
    ...
    invoke-virtual {p0, p1, p2}, LcoeditOt/TransformerGrpc$TransformerFutureStub;->build(Lio/grpc/Channel;Lio/grpc/CallOptions;)LcoeditOt/TransformerGrpc$TransformerFutureStub;
...
.method public multipleTransform(LcoeditOtMessage/MultipleTransformRequest;)Lcom/google/common/util/concurrent/ListenableFuture;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public transform(LcoeditOtMessage/TransformRequest;)Lcom/google/common/util/concurrent/ListenableFuture;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public transformWithMultiple(LcoeditOtMessage/TransformWithMultipleRequest;)Lcom/google/common/util/concurrent/ListenableFuture;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
