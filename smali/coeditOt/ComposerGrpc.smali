.class public final LcoeditOt/ComposerGrpc;
...
# static fields
.field private static final METHODID_COMPOSE:I = 0x0

.field public static final SERVICE_NAME:Ljava/lang/String; = "coeditOt.Composer"

.field private static volatile getComposeMethod:Lio/grpc/MethodDescriptor;
...
.method public static getComposeMethod()Lio/grpc/MethodDescriptor;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    .annotation build Lio/grpc/stub/annotations/RpcMethod;
        fullMethodName = "coeditOt.Composer/Compose"
        methodType = .enum Lio/grpc/MethodDescriptor$MethodType;->UNARY:Lio/grpc/MethodDescriptor$MethodType;
        requestType = LcoeditOtMessage/ComposeRequest;
        responseType = LcoeditOtMessage/ComposeResponse;
    .end annotation

    sget-object v0, LcoeditOt/ComposerGrpc;->getComposeMethod:Lio/grpc/MethodDescriptor;

    if-nez v0, :cond_1

    const-class v1, LcoeditOt/ComposerGrpc;
    ...
    const-string v2, "coeditOt.Composer"
    ...
    invoke-static {}, LcoeditOtMessage/ComposeRequest;->getDefaultInstance()LcoeditOtMessage/ComposeRequest;
    ...
    invoke-static {}, LcoeditOtMessage/ComposeResponse;->getDefaultInstance()LcoeditOtMessage/ComposeResponse;
    ...
    sput-object v0, LcoeditOt/ComposerGrpc;->getComposeMethod:Lio/grpc/MethodDescriptor;
...
.method public static getServiceDescriptor()Lio/grpc/ServiceDescriptor;
    ...
    sget-object v0, LcoeditOt/ComposerGrpc;->serviceDescriptor:Lio/grpc/ServiceDescriptor;
    ...
    const-string v0, "coeditOt.Composer"
    ...
    sput-object v0, LcoeditOt/ComposerGrpc;->serviceDescriptor:Lio/grpc/ServiceDescriptor;
...
.method public static newBlockingStub(Lio/grpc/Channel;)LcoeditOt/ComposerGrpc$ComposerBlockingStub;
    .locals 1

    new-instance v0, LcoeditOt/ComposerGrpc$2;

    invoke-direct {v0}, LcoeditOt/ComposerGrpc$2;-><init>()V
    ...
    check-cast p0, LcoeditOt/ComposerGrpc$ComposerBlockingStub;

    return-object p0
.end method

.method public static newFutureStub(Lio/grpc/Channel;)LcoeditOt/ComposerGrpc$ComposerFutureStub;
    .locals 1

    new-instance v0, LcoeditOt/ComposerGrpc$3;

    invoke-direct {v0}, LcoeditOt/ComposerGrpc$3;-><init>()V
    ...
    check-cast p0, LcoeditOt/ComposerGrpc$ComposerFutureStub;

    return-object p0
.end method

.method public static newStub(Lio/grpc/Channel;)LcoeditOt/ComposerGrpc$ComposerStub;
    .locals 1

    new-instance v0, LcoeditOt/ComposerGrpc$1;

    invoke-direct {v0}, LcoeditOt/ComposerGrpc$1;-><init>()V
    ...
    check-cast p0, LcoeditOt/ComposerGrpc$ComposerStub;
