.class public final LcoeditCore/CatcherGrpc;
...
# static fields
.field private static final METHODID_CATCHUP:I = 0x0

.field public static final SERVICE_NAME:Ljava/lang/String; = "coeditCore.Catcher"

.field private static volatile getCatchupMethod:Lio/grpc/MethodDescriptor;
...
.method public static getCatchupMethod()Lio/grpc/MethodDescriptor;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    .annotation build Lio/grpc/stub/annotations/RpcMethod;
        fullMethodName = "coeditCore.Catcher/Catchup"
        methodType = .enum Lio/grpc/MethodDescriptor$MethodType;->SERVER_STREAMING:Lio/grpc/MethodDescriptor$MethodType;
        requestType = LcoeditCoreMessage/CatchupRequest;
        responseType = LcoeditCoreMessage/CatchupResponse;
    .end annotation

    sget-object v0, LcoeditCore/CatcherGrpc;->getCatchupMethod:Lio/grpc/MethodDescriptor;

    if-nez v0, :cond_1

    const-class v1, LcoeditCore/CatcherGrpc;
    ...
    const-string v2, "coeditCore.Catcher"
    ...
    invoke-static {}, LcoeditCoreMessage/CatchupRequest;->getDefaultInstance()LcoeditCoreMessage/CatchupRequest;
    ...
    invoke-static {}, LcoeditCoreMessage/CatchupResponse;->getDefaultInstance()LcoeditCoreMessage/CatchupResponse;
    ...
    sput-object v0, LcoeditCore/CatcherGrpc;->getCatchupMethod:Lio/grpc/MethodDescriptor;
...
.method public static getServiceDescriptor()Lio/grpc/ServiceDescriptor;
    ...
    sget-object v0, LcoeditCore/CatcherGrpc;->serviceDescriptor:Lio/grpc/ServiceDescriptor;
    ...
    const-string v0, "coeditCore.Catcher"
    ...
    sput-object v0, LcoeditCore/CatcherGrpc;->serviceDescriptor:Lio/grpc/ServiceDescriptor;
...
.method public static newBlockingStub(Lio/grpc/Channel;)LcoeditCore/CatcherGrpc$CatcherBlockingStub;
    .locals 1

    new-instance v0, LcoeditCore/CatcherGrpc$2;

    invoke-direct {v0}, LcoeditCore/CatcherGrpc$2;-><init>()V
    ...
    check-cast p0, LcoeditCore/CatcherGrpc$CatcherBlockingStub;

    return-object p0
.end method

.method public static newFutureStub(Lio/grpc/Channel;)LcoeditCore/CatcherGrpc$CatcherFutureStub;
    .locals 1

    new-instance v0, LcoeditCore/CatcherGrpc$3;

    invoke-direct {v0}, LcoeditCore/CatcherGrpc$3;-><init>()V
    ...
    check-cast p0, LcoeditCore/CatcherGrpc$CatcherFutureStub;

    return-object p0
.end method

.method public static newStub(Lio/grpc/Channel;)LcoeditCore/CatcherGrpc$CatcherStub;
    .locals 1

    new-instance v0, LcoeditCore/CatcherGrpc$1;

    invoke-direct {v0}, LcoeditCore/CatcherGrpc$1;-><init>()V
    ...
    check-cast p0, LcoeditCore/CatcherGrpc$CatcherStub;
