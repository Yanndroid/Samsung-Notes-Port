.class public final LcoeditCore/PolicyManagerGrpc;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        LcoeditCore/PolicyManagerGrpc$MethodHandlers;,
        ...
        LcoeditCore/PolicyManagerGrpc$PolicyManagerImplBase;
    }
.end annotation
...
# static fields
.field private static final METHODID_REQUEST_PERMISSION:I = 0x0

.field public static final SERVICE_NAME:Ljava/lang/String; = "coeditCore.PolicyManager"

.field private static volatile getRequestPermissionMethod:Lio/grpc/MethodDescriptor;
...
.method public static getRequestPermissionMethod()Lio/grpc/MethodDescriptor;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    .annotation build Lio/grpc/stub/annotations/RpcMethod;
        fullMethodName = "coeditCore.PolicyManager/RequestPermission"
        methodType = .enum Lio/grpc/MethodDescriptor$MethodType;->UNARY:Lio/grpc/MethodDescriptor$MethodType;
        requestType = LcoeditCoreMessage/PermissionRequest;
        responseType = LcoeditCoreMessage/PermissionResponse;
    .end annotation

    sget-object v0, LcoeditCore/PolicyManagerGrpc;->getRequestPermissionMethod:Lio/grpc/MethodDescriptor;

    if-nez v0, :cond_1

    const-class v1, LcoeditCore/PolicyManagerGrpc;
    ...
    const-string v2, "coeditCore.PolicyManager"
    ...
    invoke-static {}, LcoeditCoreMessage/PermissionRequest;->getDefaultInstance()LcoeditCoreMessage/PermissionRequest;
    ...
    invoke-static {}, LcoeditCoreMessage/PermissionResponse;->getDefaultInstance()LcoeditCoreMessage/PermissionResponse;
    ...
    sput-object v0, LcoeditCore/PolicyManagerGrpc;->getRequestPermissionMethod:Lio/grpc/MethodDescriptor;
...
.method public static getServiceDescriptor()Lio/grpc/ServiceDescriptor;
    ...
    sget-object v0, LcoeditCore/PolicyManagerGrpc;->serviceDescriptor:Lio/grpc/ServiceDescriptor;
    ...
    const-string v0, "coeditCore.PolicyManager"
    ...
    sput-object v0, LcoeditCore/PolicyManagerGrpc;->serviceDescriptor:Lio/grpc/ServiceDescriptor;
...
.method public static newBlockingStub(Lio/grpc/Channel;)LcoeditCore/PolicyManagerGrpc$PolicyManagerBlockingStub;
    .locals 1

    new-instance v0, LcoeditCore/PolicyManagerGrpc$2;

    invoke-direct {v0}, LcoeditCore/PolicyManagerGrpc$2;-><init>()V
    ...
    check-cast p0, LcoeditCore/PolicyManagerGrpc$PolicyManagerBlockingStub;

    return-object p0
.end method

.method public static newFutureStub(Lio/grpc/Channel;)LcoeditCore/PolicyManagerGrpc$PolicyManagerFutureStub;
    .locals 1

    new-instance v0, LcoeditCore/PolicyManagerGrpc$3;

    invoke-direct {v0}, LcoeditCore/PolicyManagerGrpc$3;-><init>()V
    ...
    check-cast p0, LcoeditCore/PolicyManagerGrpc$PolicyManagerFutureStub;

    return-object p0
.end method

.method public static newStub(Lio/grpc/Channel;)LcoeditCore/PolicyManagerGrpc$PolicyManagerStub;
    .locals 1

    new-instance v0, LcoeditCore/PolicyManagerGrpc$1;

    invoke-direct {v0}, LcoeditCore/PolicyManagerGrpc$1;-><init>()V
    ...
    check-cast p0, LcoeditCore/PolicyManagerGrpc$PolicyManagerStub;
