.class public final LcoeditObject/UploaderGrpc$UploaderFutureStub;
...
.method public synthetic constructor <init>(Lio/grpc/Channel;Lio/grpc/CallOptions;LcoeditObject/e;)V
    .locals 0

    invoke-direct {p0, p1, p2}, LcoeditObject/UploaderGrpc$UploaderFutureStub;-><init>(Lio/grpc/Channel;Lio/grpc/CallOptions;)V
...
# virtual methods
.method public build(Lio/grpc/Channel;Lio/grpc/CallOptions;)LcoeditObject/UploaderGrpc$UploaderFutureStub;
    .locals 1

    new-instance v0, LcoeditObject/UploaderGrpc$UploaderFutureStub;

    invoke-direct {v0, p1, p2}, LcoeditObject/UploaderGrpc$UploaderFutureStub;-><init>(Lio/grpc/Channel;Lio/grpc/CallOptions;)V
...
.method public bridge synthetic build(Lio/grpc/Channel;Lio/grpc/CallOptions;)Lio/grpc/stub/AbstractStub;
    ...
    invoke-virtual {p0, p1, p2}, LcoeditObject/UploaderGrpc$UploaderFutureStub;->build(Lio/grpc/Channel;Lio/grpc/CallOptions;)LcoeditObject/UploaderGrpc$UploaderFutureStub;
...
.method public getObjectUploadUrl(LcoeditObjectMessage/ObjUploadUrlRequest;)Lcom/google/common/util/concurrent/ListenableFuture;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
