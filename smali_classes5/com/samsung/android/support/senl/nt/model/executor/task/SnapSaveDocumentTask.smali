.class public Lcom/samsung/android/support/senl/nt/model/executor/task/SnapSaveDocumentTask;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/samsung/android/support/senl/nt/model/executor/task/SnapSaveDocumentTask$Builder;,
        Lcom/samsung/android/support/senl/nt/model/executor/task/SnapSaveDocumentTask$SnapSaveTaskCallback;
    }
.end annotation


# static fields
.field private static final TAG:Ljava/lang/String; = "SnapSaveDocumentTask"


# instance fields
.field private mSnapSaveTaskCallback:Lcom/samsung/android/support/senl/nt/model/executor/task/SnapSaveDocumentTask$SnapSaveTaskCallback;
...
.method private notifyTaskEndCallback()V
    ...
    iget-object v0, p0, Lcom/samsung/android/support/senl/nt/model/executor/task/SnapSaveDocumentTask;->mSnapSaveTaskCallback:Lcom/samsung/android/support/senl/nt/model/executor/task/SnapSaveDocumentTask$SnapSaveTaskCallback;
    ...
    invoke-interface {v0, v1}, Lcom/samsung/android/support/senl/nt/model/executor/task/SnapSaveDocumentTask$SnapSaveTaskCallback;->onEnd(Ljava/lang/String;)V
...
.method public getType()Lcom/samsung/android/support/senl/nt/model/executor/task/DocumentTask$Type;
    ...
    sget-object v0, Lcom/samsung/android/support/senl/nt/model/executor/task/DocumentTask$Type;->SNAP_SAVE:Lcom/samsung/android/support/senl/nt/model/executor/task/DocumentTask$Type;
...
.method public run()V
    ...
    const-string v1, "SnapSaveDocumentTask"
    ...
    invoke-direct {p0}, Lcom/samsung/android/support/senl/nt/model/executor/task/SnapSaveDocumentTask;->notifyTaskEndCallback()V
    ...
    invoke-interface {v2, v3}, Lcom/samsung/android/support/senl/nt/model/documents/data/DocumentDataSource;->snapSave(Landroid/content/Context;)Z
...
.method public taskListener(Lcom/samsung/android/support/senl/nt/model/executor/task/SnapSaveDocumentTask$SnapSaveTaskCallback;)Lcom/samsung/android/support/senl/nt/model/executor/task/SnapSaveDocumentTask;
    .locals 0

    iput-object p1, p0, Lcom/samsung/android/support/senl/nt/model/executor/task/SnapSaveDocumentTask;->mSnapSaveTaskCallback:Lcom/samsung/android/support/senl/nt/model/executor/task/SnapSaveDocumentTask$SnapSaveTaskCallback;
