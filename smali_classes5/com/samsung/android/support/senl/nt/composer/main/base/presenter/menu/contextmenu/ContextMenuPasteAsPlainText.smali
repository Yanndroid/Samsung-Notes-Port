.class public Lcom/samsung/android/support/senl/nt/composer/main/base/presenter/menu/contextmenu/ContextMenuPasteAsPlainText;
.super Lcom/samsung/android/support/senl/nt/composer/main/base/presenter/menu/contextmenu/ContextMenuPaste;
.source "SourceFile"
...
.method public static constructor <clinit>()V
    ...
    const-string v0, "ContextMenuPasteAsPlainText"

    invoke-static {v0}, Lcom/samsung/android/support/senl/nt/composer/main/base/util/Logger;->createTag(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v0

    sput-object v0, Lcom/samsung/android/support/senl/nt/composer/main/base/presenter/menu/contextmenu/ContextMenuPasteAsPlainText;->TAG:Ljava/lang/String;
...
.method public addMenu(Landroid/view/Menu;)V
    ...
    sget v2, Lcom/samsung/android/support/senl/nt/composer/R$string;->composer_ctx_menu_paste_as_plain_text:I
...
.method public checkClipData()Z
    ...
    :cond_0
    iget-object v0, p0, Lcom/samsung/android/support/senl/nt/composer/main/base/presenter/menu/contextmenu/ContextMenuPaste;->mObjectManager:Lcom/samsung/android/support/senl/nt/composer/main/base/model/composer/ObjectManager;
    ...
    invoke-virtual {v3}, Lcom/samsung/android/support/senl/cm/base/framework/content/ClipboardManagerCompat;->getTypeAll()I

    move-result v3

    invoke-virtual {v0, v2, v3}, Lcom/samsung/android/support/senl/cm/base/framework/content/ClipboardManagerCompat;->getPrimaryClip(Landroid/content/Context;I)Landroid/content/ClipData;

    move-result-object v0

    if-nez v0, :cond_2

    sget-object v0, Lcom/samsung/android/support/senl/nt/composer/main/base/presenter/menu/contextmenu/ContextMenuPasteAsPlainText;->TAG:Ljava/lang/String;

    const-string v2, "checkClipData# clipData is null."
    ...
    const-string v2, "checkClipData# ClipDescription is null."
