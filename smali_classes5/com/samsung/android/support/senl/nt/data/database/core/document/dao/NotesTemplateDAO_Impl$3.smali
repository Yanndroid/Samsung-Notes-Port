.class Lcom/samsung/android/support/senl/nt/data/database/core/document/dao/NotesTemplateDAO_Impl$3;
...
.method public constructor <init>(Lcom/samsung/android/support/senl/nt/data/database/core/document/dao/NotesTemplateDAO_Impl;Landroidx/room/RoomDatabase;)V
    ...
    iput-object p1, p0, Lcom/samsung/android/support/senl/nt/data/database/core/document/dao/NotesTemplateDAO_Impl$3;->this$0:Lcom/samsung/android/support/senl/nt/data/database/core/document/dao/NotesTemplateDAO_Impl;
...
.method public bridge synthetic bind(Landroidx/sqlite/db/SupportSQLiteStatement;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1, p2}, Lcom/samsung/android/support/senl/nt/data/database/core/document/dao/NotesTemplateDAO_Impl$3;->bind(Landroidx/sqlite/db/SupportSQLiteStatement;Lcom/samsung/android/support/senl/nt/data/database/core/document/entry/entity/NotesTemplateEntity;)V
...
.method public createQuery()Ljava/lang/String;
    ...
    const-string v0, "UPDATE OR ABORT `document_template` SET `_id` = ?,`_data` = ?,`_size` = ?,`_display_name` = ?,`title` = ?,`createdAt` = ?,`lastModifiedAt` = ?,`mime_type` = ?,`width` = ?,`height` = ?,`type` = ? WHERE `_id` = ?"
