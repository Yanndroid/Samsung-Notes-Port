.class public final Lcom/samsung/android/support/senl/nt/data/database/core/document/dao/NotesRestoreDAO_Impl;
.super Lcom/samsung/android/support/senl/nt/data/database/core/document/dao/NotesRestoreDAO;
.source "SourceFile"
...
.field private final __preparedStmtOfResetUncategorizedFolderParentUuid:Landroidx/room/SharedSQLiteStatement;
...
.method public constructor <init>(Landroidx/room/RoomDatabase;)V
    ...
    invoke-direct {p0}, Lcom/samsung/android/support/senl/nt/data/database/core/document/dao/NotesRestoreDAO;-><init>()V

    iput-object p1, p0, Lcom/samsung/android/support/senl/nt/data/database/core/document/dao/NotesRestoreDAO_Impl;->__db:Landroidx/room/RoomDatabase;

    new-instance v0, Lcom/samsung/android/support/senl/nt/data/database/core/document/dao/NotesRestoreDAO_Impl$1;

    invoke-direct {v0, p0, p1}, Lcom/samsung/android/support/senl/nt/data/database/core/document/dao/NotesRestoreDAO_Impl$1;-><init>(Lcom/samsung/android/support/senl/nt/data/database/core/document/dao/NotesRestoreDAO_Impl;Landroidx/room/RoomDatabase;)V

    iput-object v0, p0, Lcom/samsung/android/support/senl/nt/data/database/core/document/dao/NotesRestoreDAO_Impl;->__updateAdapterOfNotesDocumentEntity:Landroidx/room/EntityDeletionOrUpdateAdapter;

    new-instance v0, Lcom/samsung/android/support/senl/nt/data/database/core/document/dao/NotesRestoreDAO_Impl$2;

    invoke-direct {v0, p0, p1}, Lcom/samsung/android/support/senl/nt/data/database/core/document/dao/NotesRestoreDAO_Impl$2;-><init>(Lcom/samsung/android/support/senl/nt/data/database/core/document/dao/NotesRestoreDAO_Impl;Landroidx/room/RoomDatabase;)V

    iput-object v0, p0, Lcom/samsung/android/support/senl/nt/data/database/core/document/dao/NotesRestoreDAO_Impl;->__preparedStmtOfResetUncategorizedFolderParentUuid:Landroidx/room/SharedSQLiteStatement;

    return-void
.end method

.method public static synthetic access$001(Lcom/samsung/android/support/senl/nt/data/database/core/document/dao/NotesRestoreDAO_Impl;)V
    .locals 0

    invoke-super {p0}, Lcom/samsung/android/support/senl/nt/data/database/core/document/dao/NotesRestoreDAO;->repairUncategorizedFolder()V
...
# virtual methods
.method public deleteDummyNewFoldersInCategoryTree(Ljava/util/List;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iget-object v0, p0, Lcom/samsung/android/support/senl/nt/data/database/core/document/dao/NotesRestoreDAO_Impl;->__db:Landroidx/room/RoomDatabase;
    ...
    const-string v1, "DELETE FROM category_tree WHERE UUID IN ("
    ...
    iget-object v1, p0, Lcom/samsung/android/support/senl/nt/data/database/core/document/dao/NotesRestoreDAO_Impl;->__db:Landroidx/room/RoomDatabase;
    ...
    :cond_1
    iget-object p1, p0, Lcom/samsung/android/support/senl/nt/data/database/core/document/dao/NotesRestoreDAO_Impl;->__db:Landroidx/room/RoomDatabase;
...
.method public deleteDummyNewFoldersInCategoryTreeClosure(Ljava/util/List;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    const-string v1, "DELETE FROM category_tree_closure WHERE descendant IN ("
...
.method public getCorruptNotes()Ljava/util/List;
    ...
    iget-object v0, v1, Lcom/samsung/android/support/senl/nt/data/database/core/document/dao/NotesRestoreDAO_Impl;->__db:Landroidx/room/RoomDatabase;
...
.method public getDummyFolders()Ljava/util/List;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    const-string v0, "SELECT UUID FROM category_tree WHERE parentUUID = \'uncategorized:///\' AND UUID NOT IN (SELECT ancestor FROM category_tree_closure WHERE depth > 0) AND UUID NOT IN (SELECT categoryUUID FROM sdoc) AND isDeleted = 0"
    ...
    iget-object v2, p0, Lcom/samsung/android/support/senl/nt/data/database/core/document/dao/NotesRestoreDAO_Impl;->__db:Landroidx/room/RoomDatabase;
...
.method public getUncategorizedFolderParentUuid()Ljava/lang/String;
    .locals 5

    const-string v0, "SELECT parentUUID FROM category_tree WHERE UUID=\'uncategorized:///\'"
...
.method public repairUncategorizedFolder()V
    ...
    :try_start_0
    invoke-static {p0}, Lcom/samsung/android/support/senl/nt/data/database/core/document/dao/NotesRestoreDAO_Impl;->access$001(Lcom/samsung/android/support/senl/nt/data/database/core/document/dao/NotesRestoreDAO_Impl;)V
...
.method public resetUncategorizedFolderParentUuid()V
    .locals 3
    ...
    iget-object v0, p0, Lcom/samsung/android/support/senl/nt/data/database/core/document/dao/NotesRestoreDAO_Impl;->__preparedStmtOfResetUncategorizedFolderParentUuid:Landroidx/room/SharedSQLiteStatement;
    ...
    iget-object v1, p0, Lcom/samsung/android/support/senl/nt/data/database/core/document/dao/NotesRestoreDAO_Impl;->__preparedStmtOfResetUncategorizedFolderParentUuid:Landroidx/room/SharedSQLiteStatement;
    ...
    iget-object v2, p0, Lcom/samsung/android/support/senl/nt/data/database/core/document/dao/NotesRestoreDAO_Impl;->__preparedStmtOfResetUncategorizedFolderParentUuid:Landroidx/room/SharedSQLiteStatement;
...
.method public update(Lcom/samsung/android/support/senl/nt/data/database/core/document/entry/entity/NotesDocumentEntity;)I
    ...
    :try_start_0
    iget-object v0, p0, Lcom/samsung/android/support/senl/nt/data/database/core/document/dao/NotesRestoreDAO_Impl;->__updateAdapterOfNotesDocumentEntity:Landroidx/room/EntityDeletionOrUpdateAdapter;
