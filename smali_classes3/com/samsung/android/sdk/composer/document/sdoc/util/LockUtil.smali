.class public Lcom/samsung/android/sdk/composer/document/sdoc/util/LockUtil;
...
.field private static final TAG:Ljava/lang/String; = "SpenSDocLockUtil"
...
.method private static concatFile(Ljava/lang/String;Ljava/lang/String;)V
    .locals 3
...
.method public static decrypt(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v1, "SpenSDocLockUtil"
    ...
    :cond_0
    invoke-static {p0, v0, p1}, Lcom/samsung/android/sdk/composer/document/sdoc/util/LockUtil;->decrypt(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    :try_start_0
    invoke-virtual {v2, v0, v4}, Lcom/samsung/android/sdk/composer/document/sdoc/util/EndTagUtil;->parse(Ljava/lang/String;Z)V
    :try_end_0
    ...
    invoke-static {v0, p0}, Lcom/samsung/android/sdk/composer/document/sdoc/util/LockUtil;->forceRenameTo(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :cond_1
    new-instance p0, Lcom/samsung/android/sdk/composer/document/sdoc/exception/SpenSDocInvalidPasswordException;

    invoke-direct {p0, v5}, Lcom/samsung/android/sdk/composer/document/sdoc/exception/SpenSDocInvalidPasswordException;-><init>(Ljava/lang/String;)V
...
.method public static decrypt(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v0, "SpenSDocLockUtil"
    ...
    invoke-virtual {v1, p0, v3}, Lcom/samsung/android/sdk/composer/document/sdoc/util/EndTagUtil;->parse(Ljava/lang/String;Z)V
    ...
    invoke-static {p0, p1, p2, v1}, Lcom/samsung/android/sdk/composer/document/sdoc/util/LockUtil;->decryptCore(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Lcom/samsung/android/sdk/composer/document/sdoc/util/EndTagUtil;)V

    new-instance p0, Lcom/samsung/android/sdk/composer/document/sdoc/util/EndTagUtil;

    invoke-direct {p0, v2}, Lcom/samsung/android/sdk/composer/document/sdoc/util/EndTagUtil;-><init>(Ljava/lang/String;)V

    :try_start_0
    invoke-virtual {p0, p1, v3}, Lcom/samsung/android/sdk/composer/document/sdoc/util/EndTagUtil;->parse(Ljava/lang/String;Z)V
    :try_end_0
    .catch Lcom/samsung/android/sdk/composer/document/sdoc/exception/SpenSDocUnsupportedFileException; {:try_start_0 .. :try_end_0} :catch_0

    invoke-virtual {v1}, Lcom/samsung/android/sdk/composer/document/sdoc/util/EndTagUtil;->getReminderData()Ljava/util/ArrayList;

    move-result-object p2

    invoke-virtual {p0, p2}, Lcom/samsung/android/sdk/composer/document/sdoc/util/EndTagUtil;->setReminderData(Ljava/util/ArrayList;)V

    invoke-virtual {v1}, Lcom/samsung/android/sdk/composer/document/sdoc/util/EndTagUtil;->isFavorite()Z

    move-result p2

    invoke-virtual {p0, p2}, Lcom/samsung/android/sdk/composer/document/sdoc/util/EndTagUtil;->setFavorite(Z)V

    invoke-virtual {v1}, Lcom/samsung/android/sdk/composer/document/sdoc/util/EndTagUtil;->getCreatedTime()J

    move-result-wide v2

    invoke-virtual {p0, v2, v3}, Lcom/samsung/android/sdk/composer/document/sdoc/util/EndTagUtil;->setCreatedTime(J)V

    invoke-virtual {v1}, Lcom/samsung/android/sdk/composer/document/sdoc/util/EndTagUtil;->getModifiedTime()J

    move-result-wide v1

    invoke-virtual {p0, v1, v2}, Lcom/samsung/android/sdk/composer/document/sdoc/util/EndTagUtil;->setModifiedTime(J)V

    invoke-virtual {p0, p1}, Lcom/samsung/android/sdk/composer/document/sdoc/util/EndTagUtil;->update(Ljava/lang/String;)V
    ...
    invoke-direct {p0, p1}, Lcom/samsung/android/sdk/composer/document/sdoc/exception/SpenSDocInvalidPasswordException;-><init>(Ljava/lang/String;)V
...
.method public static decryptCore(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Lcom/samsung/android/sdk/composer/document/sdoc/util/EndTagUtil;)V
    .locals 17
    ...
    const-string v7, "SpenSDocLockUtil"

    invoke-static {v7, v6}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    invoke-virtual/range {p3 .. p3}, Lcom/samsung/android/sdk/composer/document/sdoc/util/EndTagUtil;->getEncryptionSalt()[B

    move-result-object v6

    invoke-virtual/range {p3 .. p3}, Lcom/samsung/android/sdk/composer/document/sdoc/util/EndTagUtil;->getEncryptionIv()[B

    move-result-object v8

    invoke-virtual/range {p3 .. p3}, Lcom/samsung/android/sdk/composer/document/sdoc/util/EndTagUtil;->getEncryptionKey()[B
    ...
    invoke-virtual/range {p3 .. p3}, Lcom/samsung/android/sdk/composer/document/sdoc/util/EndTagUtil;->getEncryptionSize()I
    ...
    new-instance v0, Lcom/samsung/android/sdk/composer/document/sdoc/exception/SpenSDocInvalidPasswordException;
    ...
    invoke-direct {v0, v1}, Lcom/samsung/android/sdk/composer/document/sdoc/exception/SpenSDocInvalidPasswordException;-><init>(Ljava/lang/String;)V
    ...
    new-instance v1, Lcom/samsung/android/sdk/composer/document/sdoc/exception/SpenSDocInvalidPasswordException;
    ...
    invoke-direct {v1, v0}, Lcom/samsung/android/sdk/composer/document/sdoc/exception/SpenSDocInvalidPasswordException;-><init>(Ljava/lang/String;)V
...
.method private static deleteFile(Ljava/io/File;)V
    ...
    invoke-static {v3}, Lcom/samsung/android/sdk/composer/document/sdoc/util/LockUtil;->deleteFile(Ljava/io/File;)V
...
.method public static encrypt(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v3, "SpenSDocLockUtil"
    ...
    new-instance v4, Lcom/samsung/android/sdk/composer/document/sdoc/util/EndTagUtil;

    const/4 v5, 0x0

    invoke-direct {v4, v5}, Lcom/samsung/android/sdk/composer/document/sdoc/util/EndTagUtil;-><init>(Ljava/lang/String;)V

    const/4 v6, 0x1

    invoke-virtual {v4, v0, v6}, Lcom/samsung/android/sdk/composer/document/sdoc/util/EndTagUtil;->parse(Ljava/lang/String;Z)V
    ...
    invoke-static {v12}, Lcom/samsung/android/sdk/pen/document/util/LogUtil;->logPath(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v4, v2, v5, v11, v1}, Lcom/samsung/android/sdk/composer/document/sdoc/util/EndTagUtil;->setEncryptionInfo(I[B[B[B)V

    invoke-virtual {v4}, Lcom/samsung/android/sdk/composer/document/sdoc/util/EndTagUtil;->getCreatedTime()J

    move-result-wide v1

    invoke-virtual {v4, v1, v2}, Lcom/samsung/android/sdk/composer/document/sdoc/util/EndTagUtil;->setCreatedTime(J)V

    invoke-virtual {v4}, Lcom/samsung/android/sdk/composer/document/sdoc/util/EndTagUtil;->getModifiedTime()J

    move-result-wide v1

    invoke-virtual {v4, v1, v2}, Lcom/samsung/android/sdk/composer/document/sdoc/util/EndTagUtil;->setModifiedTime(J)V
    ...
    invoke-virtual {v4, v1, v0}, Lcom/samsung/android/sdk/composer/document/sdoc/util/EndTagUtil;->writeBytes(Ljava/lang/String;Z)V

    invoke-static {v12, v1}, Lcom/samsung/android/sdk/composer/document/sdoc/util/LockUtil;->concatFile(Ljava/lang/String;Ljava/lang/String;)V

    move-object/from16 v0, p0

    invoke-static {v12, v0}, Lcom/samsung/android/sdk/composer/document/sdoc/util/LockUtil;->forceRenameTo(Ljava/lang/String;Ljava/lang/String;)V
...
.method private static forceRenameTo(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :cond_1
    invoke-static {v1}, Lcom/samsung/android/sdk/composer/document/sdoc/util/LockUtil;->deleteFile(Ljava/io/File;)V
    ...
    :cond_5
    :goto_0
    const-string p0, "SpenSDocLockUtil"
...
.method public static isInvalidDecryption(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Z
    .locals 6

    const-string v0, "SpenSDocLockUtil"

    const-string v1, "isInvalidDecryption() - start"
    ...
    const-string p0, "isInvalidDecryption() - file isn\'t exist"
    ...
    :try_start_0
    invoke-virtual {v1, p0, v4}, Lcom/samsung/android/sdk/composer/document/sdoc/util/EndTagUtil;->parse(Ljava/lang/String;Z)V
    ...
    const-string p0, "isInvalidDecryption() - this file is not locked"
    ...
    invoke-direct {p0, v3}, Lcom/samsung/android/sdk/composer/document/sdoc/util/EndTagUtil;-><init>(Ljava/lang/String;)V

    :try_start_1
    invoke-virtual {p0, p1, v4}, Lcom/samsung/android/sdk/composer/document/sdoc/util/EndTagUtil;->parse(Ljava/lang/String;Z)V
    :try_end_1
    ...
    const-string p2, "isInvalidDecryption() - catch Exception : "
    ...
    :goto_1
    const-string p0, "isInvalidDecryption end"
    ...
    const-string p2, "isInvalidDecryption() - invalid file : "
    ...
    const-string p2, "isInvalidDecryption() - decrypt exception : "
    ...
    const-string p1, "isInvalidDecryption() - invalid argument"
