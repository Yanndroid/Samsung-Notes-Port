.class final enum Lcom/samsung/android/sdk/pen/engine/pointericon/SpenHoverPointerIcon$CustomPointerIconType;
...
.method public static constructor <clinit>()V
    ...
    new-instance v1, Lcom/samsung/android/sdk/pen/engine/pointericon/SpenHoverPointerIcon$CustomPointerIconType;

    const-string v3, "CUSTOM_DRAWABLE"

    const/4 v4, 0x1

    invoke-direct {v1, v3, v4}, Lcom/samsung/android/sdk/pen/engine/pointericon/SpenHoverPointerIcon$CustomPointerIconType;-><init>(Ljava/lang/String;I)V

    sput-object v1, Lcom/samsung/android/sdk/pen/engine/pointericon/SpenHoverPointerIcon$CustomPointerIconType;->CUSTOM_DRAWABLE:Lcom/samsung/android/sdk/pen/engine/pointericon/SpenHoverPointerIcon$CustomPointerIconType;

    new-instance v3, Lcom/samsung/android/sdk/pen/engine/pointericon/SpenHoverPointerIcon$CustomPointerIconType;

    const-string v5, "CUSTOM_ICONTYPE"

    const/4 v6, 0x2

    invoke-direct {v3, v5, v6}, Lcom/samsung/android/sdk/pen/engine/pointericon/SpenHoverPointerIcon$CustomPointerIconType;-><init>(Ljava/lang/String;I)V

    sput-object v3, Lcom/samsung/android/sdk/pen/engine/pointericon/SpenHoverPointerIcon$CustomPointerIconType;->CUSTOM_ICONTYPE:Lcom/samsung/android/sdk/pen/engine/pointericon/SpenHoverPointerIcon$CustomPointerIconType;

    new-instance v5, Lcom/samsung/android/sdk/pen/engine/pointericon/SpenHoverPointerIcon$CustomPointerIconType;

    const-string v7, "CUSTOM_ICONTYPE_TOOLTYPE"

    const/4 v8, 0x3

    invoke-direct {v5, v7, v8}, Lcom/samsung/android/sdk/pen/engine/pointericon/SpenHoverPointerIcon$CustomPointerIconType;-><init>(Ljava/lang/String;I)V

    sput-object v5, Lcom/samsung/android/sdk/pen/engine/pointericon/SpenHoverPointerIcon$CustomPointerIconType;->CUSTOM_ICONTYPE_TOOLTYPE:Lcom/samsung/android/sdk/pen/engine/pointericon/SpenHoverPointerIcon$CustomPointerIconType;

    const/4 v7, 0x4

    new-array v7, v7, [Lcom/samsung/android/sdk/pen/engine/pointericon/SpenHoverPointerIcon$CustomPointerIconType;
    ...
    sput-object v7, Lcom/samsung/android/sdk/pen/engine/pointericon/SpenHoverPointerIcon$CustomPointerIconType;->$VALUES:[Lcom/samsung/android/sdk/pen/engine/pointericon/SpenHoverPointerIcon$CustomPointerIconType;
...
.method public static values()[Lcom/samsung/android/sdk/pen/engine/pointericon/SpenHoverPointerIcon$CustomPointerIconType;
    ...
    invoke-virtual {v0}, [Lcom/samsung/android/sdk/pen/engine/pointericon/SpenHoverPointerIcon$CustomPointerIconType;->clone()Ljava/lang/Object;
