...
.method public static constructor <clinit>()V
    ...
    new-instance v1, Lcom/samsung/android/spen/libse/SeMediaRecorder$RecorderTaskState;

    const-string v3, "READY"

    const/4 v4, 0x1

    invoke-direct {v1, v3, v4}, Lcom/samsung/android/spen/libse/SeMediaRecorder$RecorderTaskState;-><init>(Ljava/lang/String;I)V

    sput-object v1, Lcom/samsung/android/spen/libse/SeMediaRecorder$RecorderTaskState;->READY:Lcom/samsung/android/spen/libse/SeMediaRecorder$RecorderTaskState;

    new-instance v3, Lcom/samsung/android/spen/libse/SeMediaRecorder$RecorderTaskState;

    const-string v5, "DO_IN_BACKGROUND"

    const/4 v6, 0x2

    invoke-direct {v3, v5, v6}, Lcom/samsung/android/spen/libse/SeMediaRecorder$RecorderTaskState;-><init>(Ljava/lang/String;I)V

    sput-object v3, Lcom/samsung/android/spen/libse/SeMediaRecorder$RecorderTaskState;->DO_IN_BACKGROUND:Lcom/samsung/android/spen/libse/SeMediaRecorder$RecorderTaskState;

    new-instance v5, Lcom/samsung/android/spen/libse/SeMediaRecorder$RecorderTaskState;

    const-string v7, "ON_POST_EXECUTE"

    const/4 v8, 0x3

    invoke-direct {v5, v7, v8}, Lcom/samsung/android/spen/libse/SeMediaRecorder$RecorderTaskState;-><init>(Ljava/lang/String;I)V

    sput-object v5, Lcom/samsung/android/spen/libse/SeMediaRecorder$RecorderTaskState;->ON_POST_EXECUTE:Lcom/samsung/android/spen/libse/SeMediaRecorder$RecorderTaskState;

    const/4 v7, 0x4

    new-array v7, v7, [Lcom/samsung/android/spen/libse/SeMediaRecorder$RecorderTaskState;
    ...
    sput-object v7, Lcom/samsung/android/spen/libse/SeMediaRecorder$RecorderTaskState;->$VALUES:[Lcom/samsung/android/spen/libse/SeMediaRecorder$RecorderTaskState;
