.class public Lcom/samsung/android/support/senl/nt/base/common/util/FileUtils;
...
.field private static final FIND_FILE_EXCEPT_EXCEPTIONAL_CASE:Ljava/lang/String; = "null"
...
.method public static copyDirectory(Ljava/io/File;Ljava/io/File;)V
    ...
    const-string v1, "Error dir create dir "
    ...
    invoke-static {v4, v5}, Lcom/samsung/android/support/senl/nt/base/common/util/FileUtils;->copyDirectory(Ljava/io/File;Ljava/io/File;)V
    ...
    const-string v1, "Error create dir "
    ...
    const-string v0, "copyDirectory - failed to read the file"
...
.method public static copyFile(Ljava/io/File;Ljava/io/File;ZZ)I
    ...
    invoke-static {v4, v5, p2, v3}, Lcom/samsung/android/support/senl/nt/base/common/util/FileUtils;->copyFile(Ljava/io/File;Ljava/io/File;ZZ)I
    ...
    invoke-static {v4, v5, p2, v1}, Lcom/samsung/android/support/senl/nt/base/common/util/FileUtils;->copyFile(Ljava/io/File;Ljava/io/File;ZZ)I
...
.method public static copyFile(Ljava/io/File;Ljava/io/File;)V
    ...
    invoke-static {p0}, Lcom/samsung/android/support/senl/nt/base/common/util/FileUtils;->logPath(Ljava/lang/String;)Ljava/lang/String;
...
.method public static copyFileToDirUri(Landroid/content/Context;Ljava/io/File;Landroid/net/Uri;)I
    ...
    invoke-static {p0, p2, v0}, Lcom/samsung/android/support/senl/nt/base/common/util/FileUtils;->createDirectory(Landroid/content/Context;Landroid/net/Uri;Ljava/lang/String;)Landroid/net/Uri;
    ...
    invoke-static {p0, v3, p2}, Lcom/samsung/android/support/senl/nt/base/common/util/FileUtils;->copyFileToDirUri(Landroid/content/Context;Ljava/io/File;Landroid/net/Uri;)I
    ...
    invoke-static {p0, p2, v0, v2}, Lcom/samsung/android/support/senl/nt/base/common/util/FileUtils;->createFile(Landroid/content/Context;Landroid/net/Uri;Ljava/lang/String;Ljava/lang/String;)Landroid/net/Uri;

    move-result-object p2

    invoke-static {p0, p1, p2}, Lcom/samsung/android/support/senl/nt/base/common/util/FileUtils;->copyFileToFileUri(Landroid/content/Context;Ljava/io/File;Landroid/net/Uri;)I
...
.method private static copyFileToFileUri(Landroid/content/Context;Ljava/io/File;Landroid/net/Uri;)I
    ...
    :try_start_1
    invoke-static {p1, v3}, Lcom/samsung/android/support/senl/nt/base/common/util/FileUtils;->copyFileToStream(Ljava/io/File;Ljava/io/OutputStream;)Z
    ...
    const-string p2, "copyFileToFileUri"
...
.method private static copyFileToStream(Ljava/io/File;Ljava/io/OutputStream;)Z
    .locals 8
    ...
    :try_start_1
    invoke-static {v4, p1}, Lcom/samsung/android/support/senl/nt/base/common/util/FileUtils;->copyStream(Ljava/io/InputStream;Ljava/io/OutputStream;)Z
...
.method private static copyStream(Ljava/io/InputStream;Ljava/io/OutputStream;)Z
    ...
    const-string v0, "copyStream, in close exception"

    const-string v1, "copyStream, out close exception"
    ...
    :catch_0
    invoke-static {v4, v1}, Lcom/samsung/android/support/senl/cm/base/framework/support/LoggerBase;->e(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v4, v2}, Lcom/samsung/android/support/senl/cm/base/framework/support/LoggerBase;->e(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_3
    ...
    const-string p1, "copyStream Error : %s stream is null"
...
.method public static copyUriToFile(Landroid/content/Context;Landroid/net/Uri;Ljava/io/File;)Z
    .locals 12

    const-string v0, "copyUriToFile, bOutputStream close exception"

    const-string v1, "copyUriToFile, bInputStream close exception"

    const-string v2, "copyUriToFile, outputStream close exception"

    const-string v3, "copyUriToFile, inputStream close exception"
    ...
    :try_start_4
    invoke-static {v7, v8}, Lcom/samsung/android/support/senl/nt/base/common/util/FileUtils;->copyStream(Ljava/io/InputStream;Ljava/io/OutputStream;)Z
    ...
    const-string v10, "copyUriToFile"
    ...
    invoke-static {v4, v5}, Lcom/samsung/android/support/senl/cm/base/framework/support/LoggerBase;->e(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_9
    ...
    const-string v0, "copyUriToFile result :"
...
.method private static createDirectory(Landroid/content/Context;Landroid/net/Uri;Ljava/lang/String;)Landroid/net/Uri;
    ...
    invoke-static {p0, p1, p2, v0}, Lcom/samsung/android/support/senl/nt/base/common/util/FileUtils;->createFile(Landroid/content/Context;Landroid/net/Uri;Ljava/lang/String;Ljava/lang/String;)Landroid/net/Uri;
...
.method public static createNewFile(Ljava/lang/String;)Ljava/io/File;
    ...
    const-string v4, "createNewFile, Created directory "
    ...
    const-string v1, "createNewFile, Created file "
...
.method private static deleteDirRecursive(Ljava/io/File;)Z
    .locals 4
    ...
    invoke-static {v3}, Lcom/samsung/android/support/senl/nt/base/common/util/FileUtils;->deleteDirRecursive(Ljava/io/File;)Z
...
.method public static deleteFile(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v1, "deleteFile dir/filePath "
...
.method public static deleteFile(Ljava/io/File;)Z
    ...
    :cond_0
    invoke-static {p0}, Lcom/samsung/android/support/senl/nt/base/common/util/FileUtils;->deleteDirRecursive(Ljava/io/File;)Z
...
.method public static deleteFile(Ljava/lang/String;)Z
    ...
    invoke-static {p0, v0}, Lcom/samsung/android/support/senl/nt/base/common/util/FileUtils;->deleteFile(Ljava/lang/String;Z)Z
...
.method public static deleteFile(Ljava/lang/String;Z)Z
    ...
    const-string v2, "deleteFile# file is empty or not exists "
    ...
    const-string p1, "deleteFile delete "
...
.method public static exploredFolder(Ljava/io/File;Ljava/util/List;Ljava/util/List;Z)Ljava/util/List;
    ...
    :cond_0
    invoke-static {v4, p1, p2, p3}, Lcom/samsung/android/support/senl/nt/base/common/util/FileUtils;->exploredFolder(Ljava/io/File;Ljava/util/List;Ljava/util/List;Z)Ljava/util/List;
    ...
    invoke-static {v5}, Lcom/samsung/android/support/senl/nt/base/common/util/FileUtils;->getFileExt(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v6, v2}, Lcom/samsung/android/support/senl/nt/base/common/util/FileUtils;->getFileName(Ljava/lang/String;Z)Ljava/lang/String;
...
.method public static extractFile(Ljava/lang/String;)Ljava/lang/String;
    .locals 3
    ...
    const-string v1, "extractFile filePath : "
...
.method public static extractFileName(Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string v1, "extractFileName filePath : "
    ...
    const-string v2, "extractFileName : "
...
.method public static findFile(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    .locals 6
...
.method public static findFileExcept(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    .locals 5
    ...
    const-string v1, "findFileExcept, directory/filePath : "
    ...
    const-string p1, "findFileExcept ["
    ...
    const-string v0, "findFileExcept : "
...
.method public static generateUniqueFilePath(Ljava/lang/String;)Ljava/lang/String;
    .locals 7
...
.method public static generateUniqueFilePath(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    .locals 2
    ...
    invoke-static {p0, v1, p1}, Lcom/samsung/android/support/senl/nt/base/common/util/FileUtils;->generateUniqueFilePath(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method public static generateUniqueFilePath(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    .locals 5
...
.method public static generateUniqueFilePathNoExtension(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    .locals 4
...
.method public static getCacheDirPath(Landroid/content/Context;)Ljava/lang/String;
    ...
    :cond_0
    const-string p0, "/data/user/0/com.samsung.android.app.notes/cache"
...
.method public static getDownloadDir(Landroid/content/Context;)Ljava/lang/String;
    ...
    const-string p0, "getDownloadDirPath# fail to mkdir"
    ...
    :cond_2
    :goto_0
    const-string p0, "getDownloadDirPath#, context or getCacheDir is null"

    invoke-static {v1, p0}, Lcom/samsung/android/support/senl/cm/base/framework/support/LoggerBase;->w(Ljava/lang/String;Ljava/lang/String;)V

    return-object v0
.end method

.method public static getDownloadDirWithFileSeparator(Landroid/content/Context;)Ljava/lang/String;
    .locals 1
...
.method public static getExtensionFromUri(Landroid/content/Context;Landroid/net/Uri;)Ljava/lang/String;
    ...
    invoke-static {p0, p1, v0}, Lcom/samsung/android/support/senl/nt/base/common/util/FileUtils;->getExtensionFromUri(Landroid/content/Context;Landroid/net/Uri;Z)Ljava/lang/String;
...
.method public static getExtensionFromUri(Landroid/content/Context;Landroid/net/Uri;Z)Ljava/lang/String;
    .locals 3

    invoke-static {p0, p1}, Lcom/samsung/android/support/senl/nt/base/common/util/FileUtils;->getFileNameFromUri(Landroid/content/Context;Landroid/net/Uri;)Ljava/lang/String;
    ...
    invoke-static {v1}, Lcom/samsung/android/support/senl/nt/base/common/util/FileUtils;->getFileExt(Ljava/lang/String;)Ljava/lang/String;
...
.method public static getFileNameFromUri(Landroid/content/Context;Landroid/net/Uri;)Ljava/lang/String;
    ...
    const-string v1, "getFileNameFromUri query "
...
.method public static getFileNameFromUriWithoutExt(Landroid/content/Context;Landroid/net/Uri;)Ljava/lang/String;
    .locals 1
...
.method public static getFileSize(Landroid/content/Context;Landroid/net/Uri;)J
    ...
    const-string v2, "getFileSize# fail to query file size "

    invoke-static {p1, v2, p0}, Lcom/samsung/android/support/senl/cm/base/framework/support/LoggerBase;->e(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public static getFileSize(Ljava/lang/String;)J
    ...
    const-string v2, "getFileSize, failed to read docFile path: "
    ...
    const-string v0, "getFileSize, size: "
...
.method public static isAndroidDir(Ljava/lang/String;)Z
    .locals 2
...
.method public static makeDirectory(Ljava/lang/String;)Z
    ...
    const-string p0, "makeDirectory(), a directory is not existed, make it"
    ...
    const-string p0, "makeDirectory(), fail to make a directory"
...
.method public static mkFile(Ljava/io/File;Ljava/lang/String;)Z
    .locals 7
    ...
    invoke-direct {v2, p0, v3}, Ljava/io/BufferedWriter;-><init>(Ljava/io/Writer;I)V
    :try_end_2
    ...
    invoke-virtual {v2, p1, v5, v6}, Ljava/io/Writer;->write(Ljava/lang/String;II)V
    :try_end_3
    .catchall {:try_start_3 .. :try_end_3} :catchall_0
...
.method public static moveFile(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string p0, "moveFile(), fail to rename"
...
.method public static printDirectory(Ljava/lang/String;Ljava/lang/String;)V
    .locals 7

    const-string v0, "printDirectory : "
...
.method public static readFile(Ljava/lang/String;)[B
    ...
    const-string v1, "readFile# file is empty or not exists "
    ...
    const-string v0, "readFile# file delete fail"
...
.method public static zip(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string p1, "zip# File not found"
    ...
    const-string p1, "zip# parentFile mkdirs failed"
    ...
    invoke-static {v0, p0, v2}, Lcom/samsung/android/support/senl/nt/base/common/util/FileUtils;->zipEntry(Ljava/io/File;Ljava/lang/String;Ljava/util/zip/ZipOutputStream;)V
...
.method private static zipEntry(Ljava/io/File;Ljava/lang/String;Ljava/util/zip/ZipOutputStream;)V
    ...
    invoke-static {v2, p1, p2}, Lcom/samsung/android/support/senl/nt/base/common/util/FileUtils;->zipEntry(Ljava/io/File;Ljava/lang/String;Ljava/util/zip/ZipOutputStream;)V
