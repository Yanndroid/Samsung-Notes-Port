.class public abstract LnoteSnap/NoteInfoGetterGrpc$NoteInfoGetterImplBase;
...
.method public final bindService()Lio/grpc/ServerServiceDefinition;
    ...
    invoke-static {}, LnoteSnap/NoteInfoGetterGrpc;->getServiceDescriptor()Lio/grpc/ServiceDescriptor;
    ...
    new-instance v2, LnoteSnap/NoteInfoGetterGrpc$MethodHandlers;

    const/4 v3, 0x0

    invoke-direct {v2, p0, v3}, LnoteSnap/NoteInfoGetterGrpc$MethodHandlers;-><init>(LnoteSnap/NoteInfoGetterGrpc$NoteInfoGetterImplBase;I)V
