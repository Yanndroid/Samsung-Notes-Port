.class public final LnoteSnap/NoteInfoGetterGrpc$NoteInfoGetterFutureStub;
...
.method public synthetic constructor <init>(Lio/grpc/Channel;Lio/grpc/CallOptions;LnoteSnap/e;)V
    .locals 0

    invoke-direct {p0, p1, p2}, LnoteSnap/NoteInfoGetterGrpc$NoteInfoGetterFutureStub;-><init>(Lio/grpc/Channel;Lio/grpc/CallOptions;)V
...
.method public bridge synthetic build(Lio/grpc/Channel;Lio/grpc/CallOptions;)Lio/grpc/stub/AbstractStub;
    ...
    invoke-virtual {p0, p1, p2}, LnoteSnap/NoteInfoGetterGrpc$NoteInfoGetterFutureStub;->build(Lio/grpc/Channel;Lio/grpc/CallOptions;)LnoteSnap/NoteInfoGetterGrpc$NoteInfoGetterFutureStub;
...
.method public build(Lio/grpc/Channel;Lio/grpc/CallOptions;)LnoteSnap/NoteInfoGetterGrpc$NoteInfoGetterFutureStub;
    .locals 1

    new-instance v0, LnoteSnap/NoteInfoGetterGrpc$NoteInfoGetterFutureStub;

    invoke-direct {v0, p1, p2}, LnoteSnap/NoteInfoGetterGrpc$NoteInfoGetterFutureStub;-><init>(Lio/grpc/Channel;Lio/grpc/CallOptions;)V

    return-object v0
.end method

.method public getLatestNoteInfo(LnoteSnapMessage/NoteInfoRequest;)Lcom/google/common/util/concurrent/ListenableFuture;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
