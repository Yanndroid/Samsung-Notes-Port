.class final Lio/grpc/netty/Http2ControlFrameLimitEncoder;
...
.method public static constructor <clinit>()V
    ...
    const-class v0, Lio/grpc/netty/Http2ControlFrameLimitEncoder;

    invoke-static {v0}, Lio/netty/util/internal/logging/InternalLoggerFactory;->getInstance(Ljava/lang/Class;)Lio/netty/util/internal/logging/InternalLogger;

    move-result-object v0

    sput-object v0, Lio/grpc/netty/Http2ControlFrameLimitEncoder;->logger:Lio/netty/util/internal/logging/InternalLogger;
...
.method public constructor <init>(Lio/netty/handler/codec/http2/Http2ConnectionEncoder;I)V
    ...
    new-instance p1, Lio/grpc/netty/Http2ControlFrameLimitEncoder$1;

    invoke-direct {p1, p0}, Lio/grpc/netty/Http2ControlFrameLimitEncoder$1;-><init>(Lio/grpc/netty/Http2ControlFrameLimitEncoder;)V

    iput-object p1, p0, Lio/grpc/netty/Http2ControlFrameLimitEncoder;->outstandingControlFramesListener:Lio/netty/channel/ChannelFutureListener;
    ...
    iput p1, p0, Lio/grpc/netty/Http2ControlFrameLimitEncoder;->maxOutstandingControlFrames:I

    return-void
.end method

.method public static synthetic access$010(Lio/grpc/netty/Http2ControlFrameLimitEncoder;)I
    .locals 2

    iget v0, p0, Lio/grpc/netty/Http2ControlFrameLimitEncoder;->outstandingControlFrames:I

    add-int/lit8 v1, v0, -0x1

    iput v1, p0, Lio/grpc/netty/Http2ControlFrameLimitEncoder;->outstandingControlFrames:I
...
.method private handleOutstandingControlFrames(Lio/netty/channel/ChannelHandlerContext;Lio/netty/channel/ChannelPromise;)Lio/netty/channel/ChannelPromise;
    ...
    iget-boolean v0, p0, Lio/grpc/netty/Http2ControlFrameLimitEncoder;->limitReached:Z

    if-nez v0, :cond_2

    iget v0, p0, Lio/grpc/netty/Http2ControlFrameLimitEncoder;->outstandingControlFrames:I

    iget v1, p0, Lio/grpc/netty/Http2ControlFrameLimitEncoder;->maxOutstandingControlFrames:I
    ...
    iput-boolean v2, p0, Lio/grpc/netty/Http2ControlFrameLimitEncoder;->limitReached:Z
    ...
    sget-object v1, Lio/grpc/netty/Http2ControlFrameLimitEncoder;->logger:Lio/netty/util/internal/logging/InternalLogger;

    const/4 v3, 0x3

    new-array v3, v3, [Ljava/lang/Object;

    iget v5, p0, Lio/grpc/netty/Http2ControlFrameLimitEncoder;->maxOutstandingControlFrames:I
    ...
    iget-object v1, p0, Lio/grpc/netty/Http2ControlFrameLimitEncoder;->lifecycleManager:Lio/netty/handler/codec/http2/Http2LifecycleManager;
    ...
    :cond_1
    iget p1, p0, Lio/grpc/netty/Http2ControlFrameLimitEncoder;->outstandingControlFrames:I

    add-int/2addr p1, v2

    iput p1, p0, Lio/grpc/netty/Http2ControlFrameLimitEncoder;->outstandingControlFrames:I

    invoke-interface {p2}, Lio/netty/channel/ChannelPromise;->unvoid()Lio/netty/channel/ChannelPromise;

    move-result-object p1

    iget-object p2, p0, Lio/grpc/netty/Http2ControlFrameLimitEncoder;->outstandingControlFramesListener:Lio/netty/channel/ChannelFutureListener;
...
.method public lifecycleManager(Lio/netty/handler/codec/http2/Http2LifecycleManager;)V
    ...
    iput-object p1, p0, Lio/grpc/netty/Http2ControlFrameLimitEncoder;->lifecycleManager:Lio/netty/handler/codec/http2/Http2LifecycleManager;
...
.method public writePing(Lio/netty/channel/ChannelHandlerContext;ZJLio/netty/channel/ChannelPromise;)Lio/netty/channel/ChannelFuture;
    ...
    invoke-direct {p0, p1, p5}, Lio/grpc/netty/Http2ControlFrameLimitEncoder;->handleOutstandingControlFrames(Lio/netty/channel/ChannelHandlerContext;Lio/netty/channel/ChannelPromise;)Lio/netty/channel/ChannelPromise;
...
.method public writeSettingsAck(Lio/netty/channel/ChannelHandlerContext;Lio/netty/channel/ChannelPromise;)Lio/netty/channel/ChannelFuture;
    ...
    invoke-direct {p0, p1, p2}, Lio/grpc/netty/Http2ControlFrameLimitEncoder;->handleOutstandingControlFrames(Lio/netty/channel/ChannelHandlerContext;Lio/netty/channel/ChannelPromise;)Lio/netty/channel/ChannelPromise;
